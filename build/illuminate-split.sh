...
git subsplit publish --heads="master" --no-tags src/Illuminate/Foundation/Support:git@github.com:illuminate/foundation-support.git
git subsplit publish --heads="master" --no-tags src/Illuminate/Foundation/Testing:git@github.com:illuminate/foundation-testing.git
