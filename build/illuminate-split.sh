...
git subsplit publish --heads="4.1 4.2" --no-tags src/Illuminate/Exception:git@github.com:illuminate/exception.git
...
git subsplit publish --heads="master" --no-tags src/Illuminate/Pipeline:git@github.com:illuminate/pipeline.git
