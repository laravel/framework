...
@section('content')
<div id="ColorsPage" v-cloak>
    <div class="col-md-12 text-right addNew-block">
        <a class="btn btn-primary button-custom fl-rt AddButton" data-toggle="tooltip" title="Click here to add Color" @click.prevent="addColor"> 
            <i class="fa fa-fw fa-plus-square"></i> New Material color
        </a>
    </div>
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="box-body">
                    <div class="pd-tp-14" v-if="filteredColors.length < 1"> 
                        <div class="callout callout-info">
                            <p>
                                <i class="fa fa-fw fa-info-circle"></i>No Colors found.
                            </p>
                        </div>
                    </div>
                    <!-- Vue table component -->
                    <v-client-table :columns="columns" :data="colors" :options="options" v-else>
...
<script src="{{ asset('/js/referencedata/materials/colors.js') }}"></script>
@endsection
