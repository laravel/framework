...
@section('content')
<div id="EndUsesPage" v-cloak>
    <div class="col-md-12 text-right addNew-block">
        <a class="btn btn-primary button-custom fl-rt AddButton" data-toggle="tooltip" title="Click here to add Use" @click.prevent="addColor"> 
            <i class="fa fa-fw fa-plus-square"></i> New Material End Use
        </a>
    </div>
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="box-body">
                    <div class="pd-tp-14" v-if="filteredColors.length < 1"> 
                        <div class="callout callout-info">
                            <p>
                                <i class="fa fa-fw fa-info-circle"></i>No Uses found.
                            </p>
                        </div>
                    </div>
                    <!-- Vue table component -->
                    <v-client-table :columns="columns" :data="uses" :options="options" v-else>
...
<script src="{{ asset('/js/referencedata/materials/enduses.js') }}"></script>
@endsection
