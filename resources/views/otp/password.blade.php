...
@section ('content')
    <div class="login-box">
        ...
        <div class="login-box-body">
            ...
            <form id="OTPForm" name="OTPForm" action="{{ route('password.otp') }}" method="POST">
                {{ csrf_field() }}
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6 fl-rt text-right pd-tp-6">
                        <a href="{{ route('password.otp.resend') }}" id="resendOTP" class="text-resend-otp">Resend OTP</a>
                    </div>
                </div>
            </form>
...
@section('dynamicScripts')
    ...
    <script src="{{ asset('js/otp/password.js') }}" charset="utf-8"></script>
@endsection
