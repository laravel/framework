...
Greetings from {{ $team }} team. Site Measurement with id <strong>{{ $siteId }}</strong> has been come for approval.

Click the button below to approve, reject or update the Site Measurement.
