...
Greetings from {{ $team }} team. Site Measurement with id <strong>{{ $siteId }}</strong> which was sent for approval has been rejected by approver ({{ $fromName }}).

Click the button below to review, reject or update the Site Measurement.
