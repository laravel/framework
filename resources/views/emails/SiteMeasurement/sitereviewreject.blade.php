...
Greetings from {{ $team }} team. Site Measurement with id <strong>{{ $siteId }}</strong> which was sent for review has been rejected by reviewer ({{ $fromName }}).

Click the button below to view or update the Site Measurement.
