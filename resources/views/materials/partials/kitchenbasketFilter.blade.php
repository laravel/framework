<div class="row">
    ...
    <div class="col-md-3">
        <label for="BasketType">Type of Basket</label>
        <select class="form-control" name="BasketType" id="BasketType">   
    ...
    <div class="col-md-3">
        <div class="form-group">
           ...
           <input type="text" class="form-control" name="DesignNumber" id="DesignNumber" value="" placeholder="Ex: 5526">
        </div>
    </div>
</div>
<div class="row">
    <div class="col-md-3">
        <div class="form-group">
            ...
            <select class="form-control" id="Material" name="Material">
                ...
                <option value="Stainless Steel 202 Grade">Stainless Steel 202 Grade</option>
                <option value="Stainless Steel 204 Grade">Stainless Steel 204 Grade</option>
                <option value="Stainless Steel 304 Grade">Stainless Steel 304 Grade</option>
            </select>
        </div>
    </div>
    <div class="col-md-3">
