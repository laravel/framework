<div class="row">
    ...
    <div class="col-md-3">
        <label for="HobType">Type of Hob</label>
        <select class="form-control" name="HobType" id="HobType">   
    ...
    <div class="col-md-3">
        <div class="form-group">
            <label for="Burners">No of Burners</label>
            <input type="number" step="1" class="form-control" min='2' max='5' name="Burners" id="Burners" value="" placeholder="Ex: 3"/>
        </div>
    </div>
</div>
<div class="row">
