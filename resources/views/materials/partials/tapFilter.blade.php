<div class="row">
    ...
    <div class="col-md-3">
        <label for="TapType">Type of Tap</label>
        <select class="form-control" name="TapType" id="TapType">   
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <select class="form-control" id="MountType" name="MountType">
                <option value="" selected="selected">Select Mount Type</option>
