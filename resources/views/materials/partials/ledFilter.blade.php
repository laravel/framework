<div class="row">
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="Shape" id="Shape" value="" placeholder="Ex: Circular, Square"/>
        </div>
    </div>
    <div class="col-md-3">
        <label for="Wattages">Wattages</label>
        <select name="Wattages" class="form-control" id="Wattages">
            <option value="" selected="selected">Select Wattages</option>
