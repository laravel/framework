<div class="row">
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="DesignNumber" id="DesignNumber" value="" placeholder="Ex: GL 6071 TS IS"/>
        </div>
    </div>
    <div class="col-md-3">
        <label for="ChimneyType">Type of Chimney</label>
        <select class="form-control" name="ChimneyType" id="ChimneyType">   
