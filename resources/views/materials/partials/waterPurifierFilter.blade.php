<div class="row">
    ...
    <div class="col-md-3">
        <label for="WaterPurifierType">Type of WaterPurifier</label>
        <select class="form-control" name="WaterPurifierType" id="WaterPurifierType">   
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <input type="text" class="form-control" min='5' max='15' name="Capacity" id="Capacity" value="" placeholder="Ex: 6"/>
        </div>
    </div>
</div>
<div class="row">
    <div class="col-md-3">
        <div class="form-group">
            ...
            <select class="form-control" id="PurificationStages" name="PurificationStages">
                <option value="" selected="selected">Select Purification Stages</option>
                <option value="5Stage">5 Stage</option>
                <option value="7Stage">7 Stage</option>
                <option value="8Stage">8 Stage</option>
            </select>
        </div>
    </div>
    <div class="col-md-3">
