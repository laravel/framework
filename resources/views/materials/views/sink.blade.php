            ...
            <div class="box-header with-border">
                ...
                <div class="box-header with-border">
                    <div class="row">
                        ...
                        <div class="col-md-3 col-xs-3">
                            <div class="form-group">
                                <label for="Type">Type of Sink</label>
                                <p>{{$Type}}</p>
                            </div>
                        </div>
                        <div class="col-md-3 col-xs-3">
                ...
                <h4 class="col-md-12 text-primary">Dimensions (mm)</h4>
                <div class="box-header with-border">
                    <h4 class="col-md-1 text-primary sinkDimensions">Sink</h4>
                    <div class="row">
                        <div class="col-md-3 col-xs-3">
                            <div class="form-group">
                    ...
                    <h4 class="col-md-1 text-primary sinkDimensions">Bowl</h4>
                    <div class="row">
                        <div class="col-md-3 col-xs-3">
                            <div class="form-group">
                                <label for="">Width</label>
