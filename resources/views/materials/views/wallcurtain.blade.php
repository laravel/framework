                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-3 col-xs-3">
                            <div class="form-group">
                                ...
                                $CurtainImagetag = (count($CurtainImage) > 1) ? '<i class="ion ion-images gallery-icon"></i>' : '<img src="' . URL::CDN($CurtainImage[0]["Path"]) . '" alt="Sample Laminate" class="note-thumbnail" title="' . $CurtainImage[0]["UserFileName"] . '">';
                                ?>
                                <div class="image-link">
                                    <a href="{{URL::CDN($CurtainImage[0]["Path"])}}" class="FullSheetImages" value="{{$cutainImageJson}}"  class="cursor-pointer">
                                        {!! $CurtainImagetag !!}
                                    </a>
                                </div>
                                @else
