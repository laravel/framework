        ...
        <div class="box-body">
            @if ($customers->isEmpty())
                <div class="callout callout-info mr-tp-10 mr-bt-10">
                    <p>No projects found. Click here to <a href="{{route('pnintegration.add.project')}}" title="Add a Project">Add New</a>.</p>
                </div>
            @elseif ($designItems->isEmpty())
                <div class="callout callout-info mr-tp-10 mr-bt-10">
                    <span>No design items found. Would you like to <a href="{{ route("designitems.create") }}">create</a> one?</span>
                </div>
            @else
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select name="Customer" id="Customer" class="form-control" data-api-end-point="{{ route("ideas.create.projects", "customerId") }}" data-projects-not-found="{{ route("pnintegration.add.project") }}">
                        ...
                        <div class="col-md-3 hidden hidden-idea-element">
                            <div class="form-group">
                                ...
                                <select name="Project" id="Project" class="form-control" style="width:100%" data-api-end-point="{{ route("ideas.create.rooms") }}"></select>
                            </div>
                        </div>
                        <div class="col-md-3 hidden hidden-idea-element">
                            <div class="form-group">
...
@section('dynamicScripts')
    ...
    <script src="{{ asset("js/ideas/create/manager.min.js") }}"></script>
@endsection