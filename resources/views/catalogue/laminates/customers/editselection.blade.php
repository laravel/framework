...
<link rel="stylesheet" href="{{ asset('css/catalogue/customer/editcombination.css') }}">
@endsection
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="box box-primary">
                ...
                <form id="EditCombination" method="POST" action="{{route('catalogues.laminates.combination.update.post', ["id" => $CombinationId])}}" enctype="multipart/form-data">
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <input type="submit" name="FinalizeCombSubmitBtn" value="Update Selection" class="btn btn-primary no-border-radius pd-rt-20 pd-lt-20" id="FinalizeCombSubmitBtn"/>
                            </div>
                        </div>
                    </div>
                </form>
...
<script src="{{ asset('/js/catalogue/customer/editcombination.js') }}"></script>
@endsection