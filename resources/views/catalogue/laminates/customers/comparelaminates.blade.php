...
<link rel="stylesheet" href="{{ asset('css/catalogue/customer/comparelaminates.css') }}">
@endsection
        ...
        <div class="col-md-12">
            <div class="box box-primary">
                ...
                <div class="box-body pd-tp-0 pd-rt-0 pd-bt-10 pd-lt-0">
                    ...
                    <form id="CompareLaminatesForm" method="POST" action="{{route('catalogues.laminates.compare.store')}}" enctype="multipart/form-data">
                        <div class="row">
...
<script src="{{ asset('/js/catalogue/customer/comparelaminates.js') }}"></script>
@endsection