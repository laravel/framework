...
<link rel="stylesheet" href="{{ asset('css/catalogue/designer/finalize.css') }}">
@endsection

@section('content')
<div id="FinalizeSMCatalogPage" v-cloak>
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="box box-primary">
                ...
                <form id="FinalizeCombination" method="POST" action="{{route('catalogue.combination.finalize', ["id" => ""])}}" enctype="multipart/form-data">
                        ...
                        <div class="table-responsive pd-tp-9" v-if="fileteredShortlistedLaminates.length > 0">
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <td class="text-center text-vertical-align" width="6%">@{{laminate.Glossy === "1" ? "Yes" : "No" }}</td>
                                    <td class="text-center text-vertical-align" width="14%">@{{laminate.Edgeband === "1" ? "Yes" : "No"}}</td>
                                    <td class="text-vertical-align text-center" width="16%">
                                    <span title="" class="cursor-pointer" @click.prevent="addToCombination(laminate.LaminateId, laminate, ShortlistedCombinations)" :id="laminate.LaminateId" v-if="!laminate.Active"><i class="fa fa-fw fa-plus-square" aria-hidden="true"></i>&nbsp;Add to Combination</span>
                                    <span title="" class="cursor-pointer" v-else><i class="fa fa-check check-icon" aria-hidden="true"></i>&nbsp;Added to Combination</span>
                                    </td>
                                    </tr>
                                </tbody>
                            </table>
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-10 col-xs-12 pd-tp-5 pd-bt-7">
                                <label> Action:* &nbsp;</label>
                                <input type="radio" name="Action" value="4" class="input-radio" id="Approve" :checked="Status== 4"/>
                                <label for="Approve" tabindex="0"></label>
                                <label for="Approve" class="text-normal cursor-pointer mr-rt-20">Approve</label>

                                <input type="radio" name="Action" value="3" class="input-radio" id="OnHold" :checked="Status== 3"/>
                                <label for="OnHold" tabindex="0"></label>
                                <label for="OnHold" class="text-normal cursor-pointer mr-rt-20">On Hold</label>

                                <input type="radio" name="Action" value="5" class="input-radio" id="NeedsDiscussion" :checked="Status== 5"/>
                                <label for="NeedsDiscussion" tabindex="0"></label>
                                <label for="NeedsDiscussion" class="text-normal cursor-pointer mr-rt-20">Needs Discussion</label>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <input type="submit" name="FinalizeCombSubmitBtn" value="Finalize Selection" data-toggle="tooltip" title="Finalize Shortlisted Selections" class="btn btn-primary button-custom" id="FinalizeCombSubmitBtn"/> 
                            </div>
                        </div>
                    </div>
            ...
            <div class="overlay" id="ShortListLaminateOverlay" v-if="ShowFinalizeCombOverlay">
                <div class="large loader"></div>
    ...
    <div class="modal fade" id="RoomsDetachAlert" role="dialog">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>
                        All other Selections with room <code class="idpro-codespan" >@{{selectedRoomArea}}</code> will be deleted.
                    </p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary pull-left" id="DeleteComSubmit" @click="deleteRemSelections(CombinationId)">Yes</button>
...
<script src="{{ asset('/js/catalogue/designer/finalize.js') }}"></script>
@endsection