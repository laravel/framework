...
<div class="box-header with-border text-center pd-5">
    <b>Categorise Summary And Comparison Across Specification</b>
</div>               
<div class="row"  style="page-break-after: always !important;">
    <div class="col-xs-12">
        <table class="table table-bordered">
            <tbody>
                 <tr class="bg-info room-items">
...
<div class="row" style="page-break-after: always; page-break-inside: avoid;">
    <div class="col-xs-12">
        <div class="box-header with-border text-center pd-5">
            <b>RoomWise Summary And Comparison Across Specification</b>
        </div> 
        <table class="table table-bordered">
            <tbody>
                <tr class="bg-info room-items">
