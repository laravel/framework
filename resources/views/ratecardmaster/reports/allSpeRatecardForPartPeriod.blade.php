<div class="box-body">
    ...
    <table id="AllSpecRateCardsForPeriodTable" class="table table-striped table-bordered"> 
        <thead style="border-top: 1px solid #f4f4f4" class="bg-light-blue text-center">
            <tr>
                <th width="3%" rowspan="2" class="text-center text-vertical-align pd-rt-8">#</th>
    ...
    <div class="row text-center mr-tp-8 mr-bt-10">
        <a href="{{ route('ratecards.reports.ratecardwithinperiod.download', ['type' => 'pdf', "city" => $CityId, "fromdate" => $FromDate, "todate" => $ToDate]) }}" id="DownloadPDF">
            <button type="button" class="btn btn-primary mr-rt-25">
                <i class="fa fa-file-pdf-o"></i> Download PDF
            </button>
        </a>

        <a href="{{ route('ratecards.reports.ratecardwithinperiod.download', ['type' => 'excel', "city" => $CityId, "fromdate" => $FromDate, "todate" => $ToDate]) }}" id="DownloadExcel">
