<div class="box-body">
    ...
    <table id="HistoryRateCardsTable" class="table table-striped table-bordered"> 
    ...
    <div class="row text-center mr-tp-8 mr-bt-10">
        <a href="{{ route('ratecards.reports.history.download', ['type' => 'pdf', "city" => $CityId, "itemid" => $ItemId]) }}" id="DownloadPDF">
            <button type="button" class="btn btn-primary mr-rt-25">
                <i class="fa fa-file-pdf-o"></i> Download PDF
            </button>
        </a>

        <a href="{{ route('ratecards.reports.history.download', ['type' => 'excel', "city" => $CityId, "itemid" => $ItemId]) }}" id="DownloadExcel">
