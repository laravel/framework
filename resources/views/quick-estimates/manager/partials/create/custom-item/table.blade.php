<tr class="bg-info text-center room-items">
    ...
    <td width="30%" class="rooms">
        <span class="pull-left pd-lt-10">Custom Items
            <small class="pd-lt-4">
                <u>
                    <a class="link" href="#" id="CreateCustomItem">Add a Custom Item</a>
                </u>
            </small>
        </span>
    </td>
...
@verbatim
    <tr v-for="(item, index) in customItems">
        ...
        <td class="text-vertical-align" width="30%">
            ...
            <span class="pull-right text-hover" title="Delete" @click="confirmDeletion(item.id)">
                <i class="fa fa-trash-o" aria-hidden="true"></i>
            </span>
            <span class="pull-right text-hover mr-rt-10" title="Edit" @click="showUpdateForm(item.id)">
