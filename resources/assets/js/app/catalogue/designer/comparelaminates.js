/**
 *  
 * Compare and Shortlist laminates script 
 * 
 **/
...
const VueInstance = new Vue({
    ...
    methods: {
        ...
        ComparisonLaminates() {
            let compareString = (this.ComparisonLaminate.DesignName + ((this.SearchBoxOneResult === null) ? "" : "<small class='vs-color'> Vs</small> " + this.SearchBoxOneResult.DesignName)
                    + ((this.SearchBoxTwoResult === null) ? "" : "<small class='vs-color'> Vs</small> " + this.SearchBoxTwoResult.DesignName)
                    + ((this.SearchBoxThreeResult === null) ? "" : "<small class='vs-color'> Vs</small> " + this.SearchBoxThreeResult.DesignName));
        ...
        submitSelections(event) {
            ...
            $.ajax({
                ...
                type: 'POST',
                dataType: 'json',
                data: {"Selections": selectedLams, 'userId': userDetails.userId, "shortCode": userDetails.shortCode, "projectId": this.ProjectId, 'RoomArea' : "" }
            })
