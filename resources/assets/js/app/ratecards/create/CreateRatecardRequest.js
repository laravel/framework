 ...
 * form submission.
 */
class CreateRatecardRequest extends Request
{
    /**
     ...
     * @var Selector
     */
    formSelector = '#CreateRatecardForm';
    ...
    handler(form, event, that)
    {
        ...
        .done((response) => {
            ...
            that.notifier.notifiyOverlaySuccessWithClearance(that.formSelector + "Overlay", "Ratecard created");
...
export default CreateRatecardRequest;
