...
var messages = {
    Name: {
        required: "Pattern can't be blank."
    },
    FormCategory: {
...
var dataVariables = {
    ...
    NotificationIcon: "",
    NotificationMessage: "",
    columns: ['Id', 'FormCategoryId', 'Name', 'Description', 'IsActive', 'Action'],
    options: {
        headings: {
            Id: '#',
            Name: 'Pattern',
...
/* Register components */
import CreatePattern from '../../../components/referencedata/CreatePattern';
import EditPattern from '../../../components/referencedata/EditPattern';
...
vueInstance = new Vue({
    ...
    data: dataVariables,
    components: {
        'create-color': CreatePattern,
        'edit-color': EditPattern
    },
    created() {
    ...
    computed: {
        ...
        selectedColor() {
            if (this.currentColorId) {
                return _.find(this.patterns, function (color) {
