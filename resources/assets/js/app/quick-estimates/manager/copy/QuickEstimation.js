    ...
    execute()
    {
        ...
        return new Vue({
            ...
            data: {
                ...
                paymentByOptions: [],
                units: [],
                // Basic template "required" for updating custom item without any vue rending errors.
                currentCustomItem: {
                    paymentBy: {},
                    pricePackages: [{},{},{},],
                },
                ...
                original: {
                    ...
                    tempCurrentCustomItem: undefined,
                },
            },
            ...
            computed: {
                ...
                showNoItemsWarning()
                {
                    ...
                    // Check whether atleast one custom item is selected.
                ...
                /**
                 * Get current custom item description.
                 *
                 * @return String
                 */
                currentCustomItemDescription()
                {
                    return _.isEmpty(this.currentCustomItem) ? "" : this.currentCustomItem.description;
                },
            },
            ...
            methods: {
                ...
                /**
                 * Show update form for the current custom item.
                 *
                 * @param  String  itemId
                 * @return void
                 */
                ...
                {
                    let item = _.find(this.customItems, ["id", itemId]);
                    this.currentCustomItem = _.cloneDeep(item);
                    this.original.tempCurrentCustomItem = _.cloneDeep(item);
                    // Check whether current custom item is not empty and show confirmation modal.
                    if (! _.isEmpty(this.currentCustomItem)) {
                        $("#UpdateCustomItemModal").modal("show");
                    }
                },

                /**
                 * Delete current custom item reference image.
                 *
                 * @return void
                 */
                deleteCustomItemImage()
                {
                    // Check whether current custom item is not empty and show confirmation modal.
                    if (! _.isEmpty(this.currentCustomItem)) {
                        this.currentCustomItem.image = false;
                    }
                },

                /**
                 * Confirm deletion of the current custom item.
                 *
                 * @param  String  itemId
                 * @return void
                 */
                ...
                {
                    this.currentCustomItem = _.find(this.customItems, ["id", itemId]);
                    // Check whether current custom item is not empty and show confirmation modal.
                    if (! _.isEmpty(this.currentCustomItem)) {
                        $("#DeleteCustomItemModal").modal("show");
                    }
                },

                /**
                 * Delete current custom item from custom items list.
                 *
                 * @return void
                 */
                deleteCurrentCustomItem()
                {
                    // Check whether current custom item is not empty and delete it.
                    if (! _.isEmpty(this.currentCustomItem)) {
                        // Find the current custom item index and delete it.
                        this.customItems.splice(_.findIndex(this.customItems, ["id", this.currentCustomItem.id]), 1);
                        // Delete its images if any stored in session storage.
                        window.sessionStorage.removeItem(this.currentCustomItem.id);
                        // Reset current custom item to its original template.
                        this.currentCustomItem = _.cloneDeep(this.original.currentCustomItem);
                        // Hide delete confirmation modal after the successful item deletion.
                        $("#DeleteCustomItemModal").modal("hide");
                    }
                },
