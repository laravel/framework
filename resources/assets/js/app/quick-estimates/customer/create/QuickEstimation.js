...
class QuickEstimation
{
    ...
    execute()
    {
        ...
        return new Vue({
             ...
             * @var Selector
             */
            el: "#CreateQuickEstimateApplication",
            ...
            methods: {
                ...
                bootstrap(response)
                {
                    ...
                    this.$nextTick(() => {
                        $("#CreateQuickEstimateTable").trigger("qe.items.ready");
                        $("#Name").trigger("focus");
                    });
                },
                ...
                fetchQuickEstimationItems()
                {
                    ...
                    that.formRequisites.prepareFormForAjax("#CreateQuickEstimateFormOverlay", "Fetching Quick Estimation Items");
                    // Perform ajax call to fetch items.
                    $.ajax({
                        url: $("#CreateQuickEstimateForm").data("bootstrap-url"),
                        type: "GET",
                        dataType: "json",
                    })
                    .done(this.bootstrap)
                    .fail(() => {
                        ...
                        that.notifier.notify("#CreateQuickEstimateFormNotificationArea", {
                            "status": "error",
                    ...
                    .always(() => {
                        ...
                        that.formRequisites.hideOverlay("#CreateQuickEstimateFormOverlay");
                    });
                },
