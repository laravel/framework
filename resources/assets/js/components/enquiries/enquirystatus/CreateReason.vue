<template> 
    <div class="modal fade" tabindex="-1" role="dialog" id="AddReasonModal">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title no-text-transform">Add Reason</h4>
                </div>
                <form :action="url" method="POST" accept-charset="utf-8" id="AddReasonForm">
                    <div class="modal-body pd-bt-0">
                        <div class="form-group">
                            <label for="Description">Reason*</label>
                            <input type="text" name="Description" id="Description" class="form-control" placeholder="Ex: Customer Expectations Not Met by HECHPE"/>
                        </div>
                        <div class="form-group">
                            <label for="EnquiryStatus">Enquiry Status*</label>
                            <select name="EnquiryStatus" id="EnquiryStatus" class="form-control">
                                <option value="">Select Status</option>  
                                <option v-for="status in enquiryStatus" :value="status.Id">{{ status.Name }}</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <label>Status*</label>
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-primary pull-left button-custom" id="AddReasonSubmitBtn">Save</button>
                ...
                <div class="form-overlay" v-if="loader">
                    ...
                    <div class="loader-text">Saving Reason</div>
                </div>
            </div>
