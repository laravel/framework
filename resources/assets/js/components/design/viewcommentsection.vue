                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 mr-0 pd-lt-0">
                        ...
                        <div v-for="SubComment in Comment.Reply" class="timeline-item">
                            <h3 class="timeline-header no-text-transform pd-4 designcomments">
                                ...
                                <span class="fl-rt form-group no-margin text-blue" >{{Comment.Status}}</span>                                                           
                        ...
                        <div v-else>
                            <div class="timeline-item">
                                ...
                                <div class="timeline-body mr-5 pd-lt-3"></div>
                            </div>    
                        </div>
                    </div>
                </div>
...
<script>
    export default {
        ...
        methods: {
            ...
            status(Status){
                var value = 'status ';
                if(_.includes(Status, 'Cancelled')||_.includes(Status, 'Rejected')){
                    value= value+'text-danger';
                }
                else if(_.includes(Status, 'Replied')||_.includes(Status, 'Accepted')){
                    value= value+'text-green';
                }else{
                    value= value+'text-blue';
                }
                return value;
            }
        }
