<template>
    <form :action="$parent.StoreSubBrandRoute" method="POST" accept-charset="utf-8" id="AddSubBrandForm">
        <div class="modal-body pd-bt-0">
            <div class="form-group">
                <label for="Name">Name*</label>
                <input type="text" name="Name" id="Name" class="form-control" placeholder="Ex: GreenTouch"/>
            </div>
            <div class="form-group">
                <label for="Brand">Brand*</label>
                <select name="Brand" id="Brand" class="form-control">
                    <option value="">Select a Brand</option>  
                    <option v-for="brand in $parent.brands" :value="brand.Id">{{ brand.Name }}</option>
                </select>
            </div>
            <div class="form-group">
                <label for="Description">Description</label>
                <input type="text" name="Description" id="Description" class="form-control" placeholder="Ex: GreenTouch in Greenlam"/>
            </div>
            <div class="form-group">
                <label>Status*</label>
                <div class="mr-tp-6">
        ...
        <div class="modal-footer">
            <button type="submit" class="btn btn-primary pull-left button-custom" id="AddSubBrandFormSubmitBtn">Save</button>
