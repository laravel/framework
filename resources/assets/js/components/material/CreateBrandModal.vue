<template>
    <form :action="$parent.StoreBrandUrl" method="POST" accept-charset="utf-8" id="AddBrandForm">
        <div class="modal-body pd-bt-0">
            <div class="form-group">
                <label for="Name">Name*</label>
                <input type="text" name="Name" id="Name" class="form-control" placeholder="Ex: Greenlam"/>
            </div>
            <div class="form-group">
                <label for="Description">Description</label>
                <input type="text" name="Description" id="Description" class="form-control" placeholder="Ex: Brand Description"/>
            </div>
            <div class="form-group">
                <label>Status*</label>
                <div class="mr-tp-6">
        ...
        <div class="modal-footer">
            <button type="submit" class="btn btn-primary pull-left button-custom" id="AddBrandFormSubmitBtn">Save</button>
