        ...
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">View Laminate Details</h4>
                </div>
                <div class="modal-body">                 
                    <h4 class="no-text-transform mr-tp-0 full-view-heading">{{currentLaminate.BrandName}} <span class="pipe-color">|</span> {{currentLaminate.DesignName}} <span class="pipe-color">|</span> {{currentLaminate.DesignNo}}</h4>
                    <div class="row">
                        <div class="col-xs-2">
                        ...
                        <div class="col-xs-10">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-3">
                                    <div class="form-group">
                                        <label>Swatch Image
                                            <a :href="this.$root.SwatchImageZipDownloadRoute+'/'+currentLaminate.LaminateId" title="Download all Swatch images" v-if="currentLaminate.SampleImage">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-6">
                                    <div class="form-group">
                                        ...
                                        <p class="usageList" v-html="getSuggUsage(currentLaminate.SuggestedUsage)"></p>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                ...
                if(pairingJSON) {
                    ...
                    if (pairings.length > 0) {
                        for (let i = 0; i < pairings.length; i++) {
                           let laminate = _.find(this.laminates, {'LaminateId': pairings[i].Id});
