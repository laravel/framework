...
- Return unqiue middleware stack in `SortedMiddleware::sortMiddleware()` ([#16034](https://github.com/laravel/framework/pull/16034))
...
### Removed
- Remove `Requests` import from controller stubs ([#16011](https://github.com/laravel/framework/pull/16011))
