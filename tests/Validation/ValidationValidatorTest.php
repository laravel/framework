...
class ValidationValidatorTest extends TestCase
{
    ...
    public function testValidateUrlWithoutDefault()
    {
        $trans = $this->getIlluminateArrayTranslator();
    ...
    #[DataProvider('validUrlsWithProtocols')]
    public function testValidateUrlWithProtocols($validUrl)
    {
        $trans = $this->getIlluminateArrayTranslator();
        $v = new Validator($trans, ['x' => $validUrl], ['x' => 'Url:blob,s3,sftp,foo-bar,foo.bar']);
        $this->assertTrue($v->passes());
    }
    ...
    public static function validUrlsWithProtocols()
    {
        return [
            ['blob://fully.qualified.domain/path'],
            ['foo-bar://fully.qualified.domain/path'],
            ['foo.bar://fully.qualified.domain/path'],
