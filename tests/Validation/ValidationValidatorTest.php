...
class ValidationValidatorTest extends PHPUnit_Framework_TestCase {
	...
	public function testValidateUnique()
	{
		...
		$mock = m::mock('Illuminate\Contracts\Validation\PresenceVerifier');
		...
		$mock2 = m::mock('Illuminate\Contracts\Validation\PresenceVerifier');
		...
		$mock3 = m::mock('Illuminate\Contracts\Validation\PresenceVerifier');
	...
	public function testValidationExists()
	{
		...
		$mock4 = m::mock('Illuminate\Contracts\Validation\PresenceVerifier');
