...
1'], ['x' => 'Alpha']);
	...
	public function testBeforeAndAfterWithFormat()
	{
		...
		$v = new Validator($trans, ['x' => '02/04/2012'], ['x' => 'After:03/03/2012|Before:01/05/2012']);
		$this->assertTrue($v->fails());

		$v = new Validator($trans, ['x' => '02/04/2012'], ['x' => 'date_format:d/m/Y|After:03/03/2012|Before:01/05/2012']);
		$this->assertTrue($v->passes());
	}
