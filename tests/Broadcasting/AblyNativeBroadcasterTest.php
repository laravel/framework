...
class AblyNativeBroadcasterTest extends TestCase
{
    /**
     * @var \Illuminate\Broadcasting\Broadcasters\AblyNativeBroadcaster
     */
    public $broadcaster;
    ...
    protected function setUp(): void
    {
        ...
        $this->broadcaster = m::mock(AblyNativeBroadcaster::class, [$this->ably, []])->makePartial();
    }
