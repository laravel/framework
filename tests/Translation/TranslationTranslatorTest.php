...
class TranslationTranslatorTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $t = $this->createMock('Illuminate\Translation\Translator', ['get'], [$this->getLoader(), 'en']);
        ...
        $t = $this->createMock('Illuminate\Translation\Translator', ['get'], [$this->getLoader(), 'en', 'sp']);
        ...
        $t = $this->createMock('Illuminate\Translation\Translator', ['load', 'getLine'], [$this->getLoader(), 'en']);
    ...
    {
        $t = $this->createMock('Illuminate\Translation\Translator', null, [$this->getLoader(), 'en']);
