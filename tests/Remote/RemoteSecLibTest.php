...
class RemoteSecLibGatewayTest extends PHPUnit_Framework_TestCase {
	...
	public function testKeyTextCanBeSetManually()
	{
		...
		$gateway = m::mock('Illuminate\Remote\SecLibGateway', ['127.0.0.1:22', ['username' => 'taylor', 'keytext' => 'keystuff'], $files])->makePartial();
	...
	public function getGateway()
	{
		...
		$gateway = m::mock('Illuminate\Remote\SecLibGateway', ['127.0.0.1:22', ['username' => 'taylor', 'key' => 'keypath', 'keyphrase' => 'keyphrase'], $files])->makePartial();
		$gateway->shouldReceive('getConnection')->andReturn(m::mock('StdClass'));
		return $gateway;
	}
