...
class ViewTest extends PHPUnit_Framework_TestCase {
	...
	public function testRenderSectionsReturnsFactorySections()
	{
		$view = m::mock('Illuminate\View\View[render]');
		$view->__construct(m::mock('Illuminate\View\Factory'), m::mock('Illuminate\View\Engines\EngineInterface'), 'view', 'path', array());
