...
'@endcomponentClass </div>', trim($result));
    ...
    public function testDataCamelCasing()
    {
        ...
        $this->assertSame("@component('Illuminate\Tests\View\Blade\TestProfileComponent', ['userId' => '1'], 'profile')
...
'@endcomponentClass', trim($result));
    ...
    public function testSelfClosingComponentsCanBeCompiledWithDataAndAttributes()
    {
        ...
        $this->assertSame("@component('Illuminate\Tests\View\Blade\TestAlertComponent', ['title' => 'foo'], 'alert')
...
'@endcomponentClass Words', trim($result));
    ...
    public function testSelfClosingComponentsCanBeCompiledWithBoundData()
    {
        ...
        $this->assertSame("@component('Illuminate\Tests\View\Blade\TestAlertComponent', ['title' => \$title], 'alert')
...
<?php \$component->withAttributes([]); ?>
 @endcomponentClass", trim($result));
    ...
    public function testClasslessComponents()
    {
        ...
        $this->assertSame("@component('Illuminate\View\AnonymousComponent', ['view' => 'components.anonymous-component','data' => ['name' => 'Taylor','age' => 31,'wire:model' => 'foo']], 'anonymous-component')
