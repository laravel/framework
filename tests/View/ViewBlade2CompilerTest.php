...
use Mockery as m;
use Illuminate\View\Compilers\Blade2Compiler;
use Illuminate\View\Compilers\BladeCompiler;

class ViewBlade2CompilerTest extends PHPUnit_Framework_TestCase {
	...
	{
		$compiler = new Blade2Compiler($files = $this->getFiles(), __DIR__);
	...
	{
		$compiler = new Blade2Compiler($files = $this->getFiles(), null);
