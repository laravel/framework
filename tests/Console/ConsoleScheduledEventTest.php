...
class ConsoleScheduledEventTest extends TestCase
{
    ...
    public function testBasicCronCompilation()
    {
        ...
        $event = new Event(m::mock(\Illuminate\Contracts\Cache\Repository::class), 'php foo');
        ...
        $eventA = new Event(m::mock(\Illuminate\Contracts\Cache\Repository::class), 'php foo');
        $eventB = new Event(m::mock(\Illuminate\Contracts\Cache\Repository::class), 'php foo');
        $this->assertEquals(
