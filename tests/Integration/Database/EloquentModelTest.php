...
class EloquentModelTest extends DatabaseTestCase
{
    ...
    public function testAttributeChangedTo()
    {
        ...
        $this->assertTrue($user->changedTo('score', function($score) { return $score > 0;}));
        $this->assertFalse($user->changedTo('score', function($score) { return $score < 0;}));
    ...
    public function testAttributeChangingTo()
    {
        ...
        $this->assertTrue($user->changingTo('score', function($score) { return $score > 0;}));
        $this->assertFalse($user->changingTo('score', function($score) { return $score < 0;}));
