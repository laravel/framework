...
class HandleCorsTest extends TestCase
{
    ...
    public function testAllowAllOriginsWildcardNoMatch()
    {
        ...
        $this->assertSame(null, $crawler->headers->get('Access-Control-Allow-Origin'));
    }
    ...
    public function testAllowMethodAllowed()
    {
        ...
        $this->assertSame(null, $crawler->headers->get('Access-Control-Allow-Methods'));
    ...
    public function testAllowHeaderAllowed()
    {
        ...
        $this->assertSame(null, $crawler->headers->get('Access-Control-Allow-Headers'));
        $this->assertSame(200, $crawler->getStatusCode());
