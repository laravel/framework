...
class StreamTest extends TestCase
{
    ...
    public function test_streams_are_consumed()
    {
    ...
    public function test_streams_with_smaller_chunk_length_are_consumed()
    {
        $stream = Http::withOptions(['stream' => true])
            ->get('http://example.test/stream')
    ...
    public function test_stream_lines_are_consumed()
    {
        $streams = [
            Http::withOptions(['stream' => true])
                ->get('http://example.test/stream')
                ->streamLines(), // default chunkLength (1024)
            Http::withOptions(['stream' => true])
                ->get('http://example.test/stream')
                ->streamLines(chunkLength: 1), // reads single byte
            Http::withOptions(['stream' => true])
                ->get('http://example.test/stream')
    ...
    public function test_stream_lines_with_different_separators()
    {
