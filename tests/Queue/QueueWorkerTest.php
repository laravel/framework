...
class QueueWorkerTest extends TestCase
{
    ...
    public function test_job_can_be_dispatched_based_on_priority()
    {
        ...
        $this->assertTrue($highJob->dispatched);
        $this->assertFalse($secondHighJob->dispatched);
        $this->assertFalse($lowJob->dispatched);

        $worker->runNextJob('default', 'high,low', new WorkerOptions);
        $this->assertTrue($secondHighJob->dispatched);
        $this->assertFalse($lowJob->dispatched);

        $worker->runNextJob('default', 'high,low', new WorkerOptions);
        $this->assertTrue($lowJob->dispatched);
    }
