...
class QueueDatabaseQueueTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $queue = $this->createMock('Illuminate\Queue\DatabaseQueue', ['getTime'], [$database = m::mock('Illuminate\Database\Connection'), 'table', 'default']);
    ...
    public function testBulkBatchPushesOntoDatabase()
    {
        ...
        $queue = $this->createMock('Illuminate\Queue\DatabaseQueue', ['getTime', 'getAvailableAt'], [$database, 'table', 'default']);
