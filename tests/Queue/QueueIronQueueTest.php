...
class QueueIronQueueTest extends PHPUnit_Framework_TestCase {
	...
	{
		$queue = new IronQueue($iron = m::mock(IronMQ::class), m::mock(Request::class), 'default', true);
	...
	{
		$queue = new IronQueue($iron = m::mock(IronMQ::class), m::mock(Request::class), 'default');
		$crypt = m::mock(Encrypter::class);
		$queue->setEncrypter($crypt);
	...
	{
		$now = Carbon::now();
		$queue = $this->getMock(IronQueue::class, array('getTime'), array($iron = m::mock(IronMQ::class), m::mock(Request::class), 'default', true));
		$crypt = m::mock(Encrypter::class);
		$queue->setEncrypter($crypt);
	...
	{
		$queue = $this->getMock(IronQueue::class, array('createPushedIronJob'), array($iron = m::mock(IronMQ::class), $request = m::mock(Request::class), 'default', true));
		$crypt = m::mock(Encrypter::class);
		$queue->setEncrypter($crypt);
