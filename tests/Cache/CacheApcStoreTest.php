...
class CacheApcStoreTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $apc = $this->createMock('Illuminate\Cache\ApcWrapper', ['get']);
    ...
    {
        $apc = $this->createMock('Illuminate\Cache\ApcWrapper', ['put']);
    ...
    {
        $apc = $this->createMock('Illuminate\Cache\ApcWrapper', ['increment']);
    ...
    {
        $apc = $this->createMock('Illuminate\Cache\ApcWrapper', ['decrement']);
    ...
    {
        $apc = $this->createMock('Illuminate\Cache\ApcWrapper', ['delete']);
