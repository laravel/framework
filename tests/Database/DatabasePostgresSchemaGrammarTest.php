...
class DatabasePostgresSchemaGrammarTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testAddingTimeStamps()
    {
        ...
        $this->assertEquals(1, count($statements));
        $this->assertEquals('alter table "users" add column "created_at" timestamp(0) without time zone default CURRENT_TIMESTAMP(0) not null, add column "updated_at" timestamp(0) without time zone default CURRENT_TIMESTAMP(0) not null', $statements[0]);
    }
