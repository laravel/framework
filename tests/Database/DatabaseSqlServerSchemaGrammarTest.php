...
class DatabaseSqlServerSchemaGrammarTest extends TestCase
{
    ...
    public function testAddingForeignID()
    {
        ...
        $blueprint->foreignId('team_column_id')->constrained('teams', 'id', 'team_column_constraint');
        ...
        $this->assertSame([
            ...
            'alter table "users" add constraint "team_column_constraint" foreign key ("team_column_id") references "teams" ("id")',
        ], $statements);
    }
