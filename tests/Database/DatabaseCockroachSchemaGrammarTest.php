...
use Illuminate\Database\Schema\Grammars\CockroachGrammar;

class DatabaseCockroachSchemaGrammarTest extends TestCase
{
    ...
    public function testAddingDateTime()
    {
        ...
        $statements = $blueprint->toSql($this->getConnection(), $this->getGrammar());
        $this->assertCount(1, $statements);
        $this->assertEquals('alter table "users" add column "created_at" timestamp not null', $statements[0]);
    }
    ...
    public function testAddingDateTimeTz()
    {
        ...
        $statements = $blueprint->toSql($this->getConnection(), $this->getGrammar());
        $this->assertCount(1, $statements);
        $this->assertEquals('alter table "users" add column "created_at" timestamptz not null', $statements[0]);
    }
    ...
    public function testAddingTimestamps()
    {
        ...
        $statements = $blueprint->toSql($this->getConnection(), $this->getGrammar());
        $this->assertCount(1, $statements);
        $this->assertEquals('alter table "users" add column "created_at" timestamp null, add column "updated_at" timestamp null', $statements[0]);
    }
    ...
    public function testAddingTimestampsTz()
    {
        ...
        $statements = $blueprint->toSql($this->getConnection(), $this->getGrammar());
        $this->assertCount(1, $statements);
        $this->assertEquals('alter table "users" add column "created_at" timestamptz null, add column "updated_at" timestamptz null', $statements[0]);
    }
