...
class DatabaseEloquentHasOneOfManyTest extends TestCase
{
    ...
    public function testEagerLoadingAppliesConstraintsToInnerJoinSubQuery()
    {
        ...
        $this->assertSame('select MAX("logins"."id") as "id_aggregate", "logins"."user_id" from "logins" where "logins"."user_id" = ? and "logins"."user_id" is not null and "logins"."user_id" in (?) group by "logins"."user_id"', $relation->getOneOfManySubQuery()->toSql());
    }
