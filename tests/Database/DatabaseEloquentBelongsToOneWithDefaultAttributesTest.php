...
class DatabaseEloquentBelongsToOneWithDefaultAttributesTest extends TestCase
{
    ...
    {
        $relation = $this->getMockBuilder('Illuminate\Database\Eloquent\Relations\BelongsToOne')->setMethods(['touchIfTouching'])->setConstructorArgs($this->getRelationArguments())->getMock();
