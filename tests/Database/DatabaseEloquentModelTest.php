...
class DatabaseEloquentModelTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $model = $this->createMock('EloquentModelStub', ['newQueryWithoutScopes', 'updateTimestamps']);
    ...
    {
        $model = $this->createMock('EloquentModelStub', ['newQueryWithoutScopes']);
        $query = m::mock('Illuminate\Database\Eloquent\Builder');
        $query->shouldReceive('where')->once()->with('id', '=', 1);
    ...
    {
        $model = $this->createMock('EloquentModelStub', ['newQueryWithoutScopes', 'updateTimestamps', 'fireModelEvent']);
    ...
    {
        $model = $this->createMock('EloquentDateModelStub', ['getDateFormat']);
    ...
    {
        $model = $this->createMock('Illuminate\Database\Eloquent\Model', ['newQueryWithoutScopes', 'updateTimestamps', 'touchOwners']);
        $query = m::mock('Illuminate\Database\Eloquent\Builder');
    ...
    {
        $related1 = $this->createMock('EloquentModelStub', ['newQueryWithoutScopes', 'updateTimestamps']);
        $query = m::mock('Illuminate\Database\Eloquent\Builder');
    ...
    public function testPushManyRelation()
    {
        ...
        $related2 = $this->createMock('EloquentModelStub', ['newQueryWithoutScopes', 'updateTimestamps']);
        $query = m::mock('Illuminate\Database\Eloquent\Builder');
    ...
    {
        $relation = $this->getMockBuilder('Illuminate\Database\Eloquent\Relations\BelongsTo')->setMethods(['touch'])->disableOriginalConstructor()->createMock();
