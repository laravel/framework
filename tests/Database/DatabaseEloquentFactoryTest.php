...
class DatabaseEloquentFactoryTest extends TestCase
{
    ...
    public function test_resolve_package_model_factories(): void
    {
        Factory::useNamespace('Vendor\\Package\\Database\\Factories\\');

        $resolves = [
            'Vendor\\Package\\Models\\Foo' => 'Vendor\\Package\\Database\\Factories\\FooFactory',
            'Vendor\\Package\\Models\\Bar' => 'Vendor\\Package\\Database\\Factories\\BarFactory',
            'Vendor\\Package\\Models\\Sub\\Foo' => 'Vendor\\Package\\Database\\Factories\\FooFactory',
            'Vendor\\Package\\Models\\Sub\\Bar' => 'Vendor\\Package\\Database\\Factories\\BarFactory',
        ];

        foreach ($resolves as $model => $factory) {
            self::assertSame($factory, Factory::resolveFactoryName($model));
        }
    }
