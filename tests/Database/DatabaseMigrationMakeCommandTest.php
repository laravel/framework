...
class DatabaseMigrationMakeCommandTest extends PHPUnit_Framework_TestCase {
	...
	public function testPackagePathsMayBeUsed()
	{
		...
		$app['path.database'] = __DIR__;
		$command->setLaravel($app);
		$creator->shouldReceive('create')->once()->with('create_foo', __DIR__.'/vendor/bar/resources/migrations', null, false);
	...
	public function testPackageFallsBackToVendorDirWhenNotExplicit()
	{
		...
		$creator->shouldReceive('create')->once()->with('create_foo', __DIR__.'/vendor/foo/bar/resources/migrations', null, false);
