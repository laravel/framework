...
class DatabaseMigrationMakeCommandTest extends TestCase
{
    ...
    public function testBasicCreateDumpsAutoload()
    {
        ...
        $creator->shouldReceive('create')->once()->with('create_foo', __DIR__.DIRECTORY_SEPARATOR.'migrations', null, false, false);
    ...
    public function testBasicCreateGivesCreatorProperArgumentsWhenTableIsSet()
    {
        ...
        $app->useDatabasePath(__DIR__);
        $command->setLaravel($app);
        $creator->shouldReceive('create')->once()->with('create_foo', __DIR__.DIRECTORY_SEPARATOR.'migrations', 'users', true, false);
    ...
    public function testBasicCreateGivesCreatorProperArgumentsWhenCreateTablePatternIsFound()
    {
        ...
        $app->useDatabasePath(__DIR__);
        $command->setLaravel($app);
        $creator->shouldReceive('create')->once()->with('create_users_table', __DIR__.DIRECTORY_SEPARATOR.'migrations', 'users', true, false);
    ...
    public function testCanSpecifyPathToCreateMigrationsIn()
    {
        ...
        $creator->shouldReceive('create')->once()->with('create_foo', '/home/laravel/vendor/laravel-package/migrations', 'users', true, false);
