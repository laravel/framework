...
use Illuminate\Database\Eloquent\Relations\MorphToOne;

class DatabaseEloquentMorphToOneTest extends TestCase
{
    ...
    public function testEagerConstraintsAreProperlyAdded()
    {
        ...
        $model1 = new EloquentMorphToOneModelStub;
        $model1->id = 1;
        $model2 = new EloquentMorphToOneModelStub;
        $model2->id = 2;
    ...
    {
        $relation = $this->getMockBuilder('Illuminate\Database\Eloquent\Relations\MorphToOne')->setMethods(['touchIfTouching'])->setConstructorArgs($this->getRelationArguments())->getMock();
    ...
    public function getRelation()
    {
        ...
        return new MorphToOne($builder, $parent, 'taggable', 'taggables', 'taggable_id', 'tag_id', 'id', 'id');
    }
...
class EloquentMorphToOneModelStub extends \Illuminate\Database\Eloquent\Model
{
    protected $guarded = [];
}
