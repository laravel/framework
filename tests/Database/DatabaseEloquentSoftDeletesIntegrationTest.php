...
class DatabaseEloquentSoftDeletesIntegrationTest extends TestCase
{
    ...
    public function testRestoreAfterSoftDelete()
    {
        ...
        $this->assertSame($userModel->id, SoftDeletesTestUser::find(2)->id);
    }
    ...
    public function testSoftDeleteAfterRestoring()
    {
        ...
        $userModel->restore();
        $this->assertSame($userModel->deleted_at, SoftDeletesTestUser::find(1)->deleted_at);
        $this->assertSame($userModel->getOriginal('deleted_at'), SoftDeletesTestUser::find(1)->deleted_at);
        $userModel->delete();
        $this->assertNull(SoftDeletesTestUser::find(1));
    ...
    public function testOrWhereWithSoftDeleteConstraint()
    {
        ...
        $this->assertSame(['abigailotwell@gmail.com'], $users->pluck('email')->all());
    }
    ...
    public function testMorphToWithTrashed()
    {
        ...
        $this->assertSame($abigail->email, $comment->owner->email);
    ...
    public function testMorphToNonSoftDeletingModel()
    {
        ...
        $this->assertSame($taylor->email, $comment->owner->email);
