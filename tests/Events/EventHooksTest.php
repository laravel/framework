...
class EventHooksTest extends TestCase
{
    ...
    public function test_after_callbacks_are_called_after_listeners(): void
    {
        ...
        $this->dispatcher->after(static::EVENT, $callbacks);
    ...
    public function test_failure_callbacks_are_called_on_listener_failure(): void
    {
        ...
        $this->dispatcher->failure(static::EVENT, $callbacks);
    ...
    public function test_callback_aggregation_caches_results(): void
    {
        $this->dispatcher->before(static::EVENT, static fn (): string => static::EVENT,);

        $this->call('aggregateCallbacks', [static::HOOK_BEFORE, static::EVENT, []]);

        $this->assertIsArray($this->get('cache'),
            'Dispatcher::$cache should be an array');
        $this->assertArrayHasKey(static::HOOK_BEFORE.':'.static::EVENT, $this->get('cache')['aggregated_callbacks'],
            'Dispatcher::$cache should have an entry for the before hook for the event.');
        $this->assertSame(static::EVENT, Arr::first($this->get('cache')['aggregated_callbacks'][static::HOOK_BEFORE.':'.static::EVENT])(),
            'The expected callback for the event should exist in the cache.');
    }
    ...
    {
        $aggregated = $this->call('aggregateCallbacks', [static::HOOK_BEFORE, static::EVENT, [$event = new EventWithHooks]]);
    ...
    public function test_callbacks_are_ordered_for_before_hook_correctly(): void
    {
        ...
        $ordered = $this->call('orderCallbacks', [static::HOOK_BEFORE, $registered]);
    ...
    public function test_callbacks_are_ordered_for_after_hook_correctly(): void
    {
        ...
        $ordered = $this->call('orderCallbacks', [static::HOOK_AFTER, $registered]);
    ...
    public function test_callbacks_are_ordered_for_failure_hook_correctly(): void
    {
        ...
        $ordered = $this->call('orderCallbacks', [static::HOOK_FAILURE, $registered]);
    ...
    public function test_callbacks_throw_exception_for_invalid_hook_type(): void
    {
        ...
        $this->call('orderCallbacks', [static::INVALID_CALLBACK, []]);
    }
    ...
    public function test_has_callbacks_utilizes_memoization_correctly(): void
    {
        ...
        $this->assertTrue(
            ($this->get('cache')['has_callbacks'] ?: [])[static::HOOK_BEFORE.':'.static::EVENT] ?? false,
            "\$Dispatcher::\$cache['has_callbacks'] should remain true after registering additional callback (event though the cache was cleared)."
        );
    }
...
class EventWithHooks
{
    ...
    public function before(): void
    {
        ...
        $this->beforePayload = func_get_args();
    ...
    public function after(): void
    {
        ...
        $this->afterPayload = func_get_args();
    ...
    public function failure(): void
    {
        ...
        $this->failurePayload = func_get_args();
