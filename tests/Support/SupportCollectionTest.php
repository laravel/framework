...
class SupportCollectionTest extends PHPUnit_Framework_TestCase {
	...
	{
		$data = new Collection([['rating' => 1, 'name' => '1'], ['rating' => 1, 'name' => '2'], ['rating' => 2, 'name' => '3']]);
		$result = $data->groupBy('rating');
		$this->assertEquals([1 => [['rating' => 1, 'name' => '1'], ['rating' => 1, 'name' => '2']], 2 => [['rating' => 2, 'name' => '3']]], $result->toArray());
	}
