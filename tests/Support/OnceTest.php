...
class OnceTest extends TestCase
{
    ...
    public function testResultMemoization()
    {
        $instance = new class
        {
            ...
            {
                return once(fn () => random_int(1, PHP_INT_MAX));
            }
        };
    ...
    public function testIsNotMemoizedWhenCallableUsesChanges()
    {
        ...
        a:
        $results[] = once(fn () => $letter.random_int(1, 10000000));
    ...
    {
        $resolver = fn () => once(fn () => random_int(1, PHP_INT_MAX));
    ...
    public function testMemoizationOnSameLine()
    {
        ...
        $result = [once(fn () => random_int(1, PHP_INT_MAX)), once(fn () => random_int(1, PHP_INT_MAX))];
    ...
    {
        $resolver = fn () => once(fn () => random_int(1, PHP_INT_MAX));
        $resolver2 = fn () => once(fn () => random_int(1, PHP_INT_MAX));
    ...
    public function testRecursiveOnceCalls()
    {
        $instance = new class
        {
            public function rand()
            {
                return once(fn () => once(fn () => random_int(1, PHP_INT_MAX)));
            }
        };
...
$GLOBALS['onceable1'] = fn () => once(fn () => $letter.random_int(1, PHP_INT_MAX));
$GLOBALS['onceable2'] = fn () => once(fn () => $letter.random_int(1, PHP_INT_MAX));
