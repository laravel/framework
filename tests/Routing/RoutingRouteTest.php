...
class RoutingRouteTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testBasicDispatchingOfRoutes()
    {
        ...
        $router = $this->getRouter();
        $route = $router->get('foo/bar', array('domain' => 'api.{name}.bar', function ($name) {
            return $name;
        }));
        ...
        $router = $this->getRouter();
        $router->get('{foo?}/{baz?}', array('as' => 'foo', function ($name = 'taylor', $age = 25) {
            return $name . $age;
        }));
    ...
    {
        $router = $this->getRouter();
        $route = $router->get('foo/bar', array('domain' => 'api.foo.bar', function () {
            return 'hello';
        }));
    ...
    public function testBasicBeforeFilters()
    {
        ...
        $router = $this->getRouter();
        $router->get('foo/bar', array('before' => 'foo', function () {
            return 'hello';
        }));
        $router->filter('foo', function () {
            return 'foo!';
        ...
        $router = $this->getRouter();
        $router->get('foo/bar', array('before' => 'foo:25', function () {
            return 'hello';
        }));
        $router->filter('foo', function ($route, $request, $age) {
            return $age;
        });
        $this->assertEquals('25', $router->dispatch(Request::create('foo/bar', 'GET'))->getContent());

        $router = $this->getRouter();
        $router->get('foo/bar', array('before' => 'foo:bar,baz', function () {
            return 'hello';
        }));
        ...
        $router = $this->getRouter();
        $router->get('foo/bar', array('before' => 'foo:bar,baz|bar:boom', function () {
            return 'hello';
        }));
        $router->filter('foo', function ($route, $request, $bar, $baz) {
            return null;
        });
        $router->filter('bar', function ($route, $request, $boom) {
            return $boom;
        });
        ...
        $router = $this->getRouter();
        $router->get('foo/bar', array('before' => 'foo:bar', function () {
            return 'hello';
        }));
        $router->filter('foo', function ($route, $request, $value = null) {
            $_SERVER['__route.filter'] = $value;
        });
    ...
    public function testBasicAfterFilters()
    {
        unset($_SERVER['__filter.after']);
        $router = $this->getRouter();
        $router->get('foo/bar', array('after' => 'foo', function () {
            return 'hello';
        }));
        $router->filter('foo', function () {
            $_SERVER['__filter.after'] = true;
    ...
    public function testPatternBasedFilters()
    {
        ...
        $router->filter('foo', function ($route, $request, $bar) {
            return 'foo' . $bar;
        });
        ...
        $router->filter('bar', function ($route, $request) {
            return 'bar';
        });
        $router->when('foo/*', 'foo|bar', array('get'));
    ...
    public function testRouteGrouping()
    {
        ...
        $router = $this->getRouter();
        $router->group(array('before' => 'foo'), function () use ($router) {
            $router->get('foo/bar', array('before' => 'bar', function () {
                return 'hello';
            }));
        });
        $router->filter('foo', function () {
        ...
        $router->group(array('before' => 'foo|bar'), function () use ($router) {
            $router->get('foo/bar', array('before' => 'baz', function () {
                return 'hello';
            }));
        });
        $router->filter('foo', function () {
