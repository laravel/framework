...
- [9.x] Fixes usage of `Redis::many()` with empty array by @nunomaduro in https://github.com/laravel/framework/pull/47307
- [9.x] Fix PHPStan description of Closure returning a union type by @ondrejmirtes in https://github.com/laravel/framework/pull/47352

### New Contributors

- @ondrejmirtes made their first contribution in https://github.com/laravel/framework/pull/47352

**Full Changelog**: https://github.com/laravel/framework/compare/v9.52.8...v9.52.9
