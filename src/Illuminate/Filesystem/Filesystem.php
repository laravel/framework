...
class Filesystem
{
     ...
     */
    public function basename(string $path): array|string
    {
     ...
     */
    public function dirname(string $path): array|string
    {
     ...
     */
    public function size(string $path): false|int
    {
     ...
     */
    public function glob(string $pattern, int $flags = 0): false|array
    {
