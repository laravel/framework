...
class FoundationServiceProvider extends AggregateServiceProvider
{
    ...
    {
        AbstractCloner::$defaultCasters[ConnectionInterface::class] ??= StubCaster::cutInternals(...);
        AbstractCloner::$defaultCasters[Container::class] ??= StubCaster::cutInternals(...);
        AbstractCloner::$defaultCasters[Dispatcher::class] ??= StubCaster::cutInternals(...);
        AbstractCloner::$defaultCasters[Factory::class] ??= StubCaster::cutInternals(...);
        AbstractCloner::$defaultCasters[Grammar::class] ??= StubCaster::cutInternals(...);
