...
class Application extends Container implements ApplicationContract, HttpKernelInterface
{
    ...
    public function afterLoadingEnvironment(Closure $callback)
    {
        return $this->afterBootstrapping(
            \Illuminate\Foundation\Bootstrap\DetectEnvironment::class, $callback
        );
    }
    ...
    {
        return $this[\Illuminate\Contracts\Http\Kernel::class]->handle(Request::createFromBase($request));
    }
    ...
    public function registerCoreContainerAliases()
    {
        $aliases = [
            ...
            'translator'           => [\Illuminate\Translation\Translator::class, 'Symfony\Component\Translation\TranslatorInterface'],
            ...
            'request'              => [\Illuminate\Http\Request::class, 'Symfony\Component\HttpFoundation\Request'],
            'router'               => [\Illuminate\Routing\Router::class, \Illuminate\Contracts\Routing\Registrar::class],
            'session'              => \Illuminate\Session\SessionManager::class,
            'session.store'        => [\Illuminate\Session\Store::class, 'Symfony\Component\HttpFoundation\Session\SessionInterface'],
