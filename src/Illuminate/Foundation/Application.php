...
class Application extends Container implements ApplicationContract, HttpKernelInterface {
	...
	public function registerCoreContainerAliases()
	{
		$aliases = array(
			...
			'auth.password.tokens' => 'Illuminate\Contracts\Auth\TokenRepository',
			...
			'session.store'  => ['Illuminate\Session\StoreInterface', 'Symfony\Component\HttpFoundation\Session\SessionInterface'],
