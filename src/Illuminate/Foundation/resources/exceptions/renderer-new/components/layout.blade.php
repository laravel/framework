            ...
            <div class="box-border content-stretch flex flex-row items-center justify-between px-6 py-3 relative shrink-0 w-[1272px]">
                ...
                <div class="box-border content-stretch flex flex-row gap-2 items-center justify-start p-0 relative shrink-0">
                    ...
                    <div class="font-['Inter:Medium',_sans-serif] font-medium leading-[0] not-italic relative shrink-0 text-[#ffffff] text-[14px] text-left text-nowrap tracking-[-0.28px]">
                        <p class="adjustLetterSpacing block leading-[20px] whitespace-pre">Internal Server Error</p>
                    </div>
                </div>
            ...
            <div class="flex flex-col gap-8 px-14 py-16 border-x border-white/[0.09]">
                ...
                <div class="flex flex-col gap-6">
                    <div class="flex items-center gap-[9px]">
                        <h1 class="text-3xl font-semibold text-white tracking-[-0.6px] leading-[36px]">ClickHouseDB\Exception\QueryException</h1>
                    </div>
                    <p class="text-xl font-light text-neutral-300 tracking-[-0.4px] leading-[30px] min-w-full">
                        SQLSTATE[23000]: Integrity constraint violation: 1062 Duplicate entry '1' for key 'flights_id_unique'<br>
                        (Connection: mysql, SQL: insert into "flights" ("id", "name", "created_at", "updated_at") values (?, ?, ?, ?))
                    </p>
                </div>
                ...
                <div class="flex items-start gap-2">
                    <div class="bg-white/[0.03] border border-white/[0.01] rounded-md shadow-sm flex items-center gap-0.5">
                        <div class="flex items-center gap-1.5 h-6 px-[6px] font-mono text-[13px] tracking-[-0.26px]">
                            ...
                            <span class="text-neutral-300">11.8.0</span>
                        </div>
                        ...
                        <div class="flex items-center gap-1.5 h-6 px-[6px] font-mono text-[13px] tracking-[-0.26px]">
                            ...
                            <span class="text-neutral-300">8.3.7</span>
                        </div>
                    </div>
                    ...
                    <div class="bg-rose-950 border border-rose-900 rounded-md h-6 flex items-center gap-1.5 px-[6px] min-w-6">
                        <span class="text-[13px] font-mono text-rose-100 tracking-[-0.26px]">CODE 18</span>
                    </div>
                </div>
            </div>
                    ...
                    <div class="backdrop-blur-[6px] bg-white/[0.04] border border-white/[0.01] rounded-lg flex items-center justify-between p-2 relative mt-[23px] w-full max-w-[1160px] mx-auto">
                        <div class="flex items-center gap-3">
                            ...
                            <div class="text-sm font-light text-white tracking-[-0.28px]">
                                http://localhost/environments/abf59a8e-1259-be9d-a1d1-1df4fd673736/requests/routes/2a068e4d9b57a28687ae4dc3b09ff1fb
                            </div>
                        </div>
                                ...
                                <div class="flex items-center gap-4">
                                    <div class="flex items-center gap-2">
                                        <div class="text-sm font-mono text-white tracking-[-0.28px]">
                                            2025/09/24 19:37:38.125 <span class="text-neutral-500">UTC</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center gap-2 h-10 px-0 py-[18px] w-full">
                                ...
                                <div class="flex items-center gap-4">
                                    <div class="bg-rose-500 border border-emerald-800 rounded-md h-6 flex items-center gap-1.5 px-[6px] min-w-6">
                                        ...
                                        <span class="text-[13px] font-mono text-neutral-300 tracking-[-0.26px]">GET</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="flex flex-col gap-1 p-[10px] w-full">
                        ...
                        <div class="bg-white/[0.03] rounded-md h-10 flex items-center gap-8 px-4 w-full">
                            <div class="flex items-center gap-4 flex-1 min-w-0">
                                ...
                                <div class="text-xs font-mono text-neutral-200 tracking-[-0.24px] overflow-hidden text-ellipsis flex-1 min-w-0 leading-[1.5]">
                                    <span class="text-[#f78c6c]">SELECT</span><span class="text-[#eeffff]"> user_id, </span><span class="text-[#82aaff]">COUNT</span><span class="text-[#eeffff]">(</span><span class="text-[#89ddff]">*</span><span class="text-[#eeffff]">) </span><span class="text-[#f78c6c]">as</span><span class="text-[#eeffff]"> article_count </span><span class="text-[#f78c6c]">FROM</span><span class="text-[#eeffff]"> articles </span><span class="text-[#f78c6c]">GROUP BY</span><span class="text-[#eeffff]"> user_id </span><span class="text-[#f78c6c]">ORDER BY</span><span class="text-[#eeffff]"> article_count </span><span class="text-[#f78c6c]">DESC</span><span class="text-[#eeffff]"> </span><span class="text-[#f78c6c]">LIMIT</span><span class="text-[#eeffff]"> </span><span class="text-[#f78c6c]">1</span>
                                </div>
                            </div>
                            <div class="flex items-center gap-5">
                                <div class="flex items-center gap-2"></div>
                                <div class="flex items-center gap-2">
                                    <div class="text-xs font-mono text-neutral-200 tracking-[-0.12px] w-[65px] text-right">4,470ms</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-white/[0.03] rounded-md h-10 flex items-center gap-8 px-4 w-full">
                            <div class="flex items-center gap-4 flex-1 min-w-0">
                                ...
                                <div class="text-xs font-mono text-neutral-200 tracking-[-0.24px] overflow-hidden text-ellipsis flex-1 min-w-0 leading-[1.5]">
                                    <span class="text-[#f78c6c]">INSERT INTO</span><span class="text-[#eeffff]"> users (</span><span class="text-[#f78c6c]">name</span><span class="text-[#eeffff]">, email, </span><span class="text-[#f78c6c]">password</span><span class="text-[#eeffff]">) </span><span class="text-[#f78c6c]">VALUES</span><span class="text-[#eeffff]"> (?)</span>
                                </div>
                            </div>
                            <div class="flex items-center gap-5">
                                <div class="flex items-center gap-2"></div>
                                <div class="flex items-center gap-2">
                                    <div class="text-xs font-mono text-neutral-200 tracking-[-0.12px] w-[65px] text-right">1,826ms</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col gap-5 w-full">
                        <div class="flex flex-col w-full">
                            <div class="flex items-center gap-2 h-10 px-0 py-0 w-full">
                                <div class="text-sm font-mono text-neutral-400 tracking-[-0.28px]">X-Inertia-Version</div>
                                <div class="flex-1 h-3 border-b-2 border-dotted border-white/20"></div>
                                <div class="text-sm font-mono text-white tracking-[-0.28px] max-w-[772px] overflow-hidden text-ellipsis leading-[1.6]">4cda6be5c3e7ad0062aa6e8683d02867</div>
                            </div>
                            <div class="flex items-center gap-2 h-10 px-0 py-0 w-full">
                                <div class="text-sm font-mono text-neutral-400 tracking-[-0.28px]">Accept</div>
                                <div class="flex-1 h-3 border-b-2 border-dotted border-white/20"></div>
                                <div class="text-sm font-mono text-white tracking-[-0.28px] max-w-[772px] overflow-hidden text-ellipsis leading-[1.6]">text/html,application/xhtml+xml</div>
                            </div>
                            <div class="flex items-center gap-2 h-10 px-0 py-0 w-full">
                                <div class="text-sm font-mono text-neutral-400 tracking-[-0.28px]">User-Agent</div>
                                <div class="flex-1 h-3 border-b-2 border-dotted border-white/20"></div>
                                <div class="text-sm font-mono text-white tracking-[-0.28px] max-w-[772px] overflow-hidden text-ellipsis leading-[1.6]">Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_7)</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex flex-col gap-2 overflow-hidden w-full">
                    ...
                    <div class="bg-white/[0.02] border border-white/[0] rounded-md shadow-[0px_16px_32px_-8px_rgba(12,12,13,0.4)] w-full">
                        <div class="flex flex-col overflow-hidden p-5 w-full">
                            <pre class="text-sm font-mono text-white tracking-[-0.28px] leading-[1.7] max-w-[780px] whitespace-pre">
<span class="text-[#b392f0]">{</span>
<span class="text-[#b392f0]">   "period": </span><span class="text-[#ffab70]">"14d"</span>
<span class="text-[#b392f0]">}</span></pre>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex flex-col overflow-hidden w-full">
                    ...
                    <div class="flex flex-col w-full">
                        <div class="flex items-center gap-2 h-10 px-0 py-0 w-full">
                            <div class="text-sm font-mono text-neutral-400 tracking-[-0.28px]">Controller</div>
                            <div class="flex-1 h-3 border-b-2 border-dotted border-white/20"></div>
                            <div class="text-sm font-mono text-white tracking-[-0.28px] max-w-[772px] overflow-hidden text-ellipsis leading-[1.6]">
                                App\Http\Controllers\RequestRouteController@show
                            </div>
                        </div>
                        <div class="flex items-center gap-2 h-10 px-0 py-0 w-full">
                            <div class="text-sm font-mono text-neutral-400 tracking-[-0.28px]">Middleware</div>
                            <div class="flex-1 h-3 border-b-2 border-dotted border-white/20"></div>
                            <div class="text-sm font-mono text-white tracking-[-0.28px] max-w-[772px] overflow-hidden text-ellipsis leading-[1.6]">
                                web, auth, can:view,environment, App\Http\Middleware\UpdateLastEnvironment, Laravel\Nightwatch\Hooks\RouteMiddleware
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex flex-col gap-2 overflow-hidden w-full">
                    ...
                    <div class="bg-white/[0.02] border border-white/[0] rounded-md shadow-[0px_16px_32px_-8px_rgba(12,12,13,0.4)] w-full">
                        <div class="flex flex-col overflow-hidden p-5 w-full">
                            <pre class="text-sm font-mono text-white tracking-[-0.28px] leading-[1.7] max-w-[780px] w-full">
<span class="text-[#b392f0]">{</span>
<span class="text-[#b392f0]">  "environment": </span><span class="text-[#9db1c5]">{</span>
<span class="text-[#b392f0]">    "clickhouse_id": </span><span class="text-[#f8f8f8]">1</span><span class="text-[#9db1c5]">,</span>
<span class="text-[#b392f0]">    "id": </span><span class="text-[#ffab70]">"abf59a8e-1259-be9d-a1d1-1df4fd673736"</span><span class="text-[#9db1c5]">,</span>
<span class="text-[#b392f0]">    "application_id": </span><span class="text-[#ffab70]">"49cd57fe-dbba-86d7-21cc-7db6e01bc440"</span><span class="text-[#9db1c5]">,</span>
<span class="text-[#b392f0]">    "name": </span><span class="text-[#ffab70]">"Production"</span><span class="text-[#9db1c5]">,</span>
<span class="text-[#b392f0]">    "created_at": </span><span class="text-[#ffab70]">"2025-05-20T04:16:41.000000Z"</span><span class="text-[#9db1c5]">,</span>
<span class="text-[#b392f0]">    "updated_at": </span><span class="text-[#ffab70]">"2025-05-20T04:16:41.000000Z"</span><span class="text-[#9db1c5]">,</span>
<span class="text-[#b392f0]">    "token": </span><span class="text-[#ffab70]">"QIsoaaTWi6WYIB69OiUpm648F8JGoTTrbh7XhZSnacTg"</span><span class="text-[#9db1c5]">,</span>
<span class="text-[#b392f0]">    "color": </span><span class="text-[#ffab70]">"blue"</span><span class="text-[#9db1c5]">,</span>
<span class="text-[#b392f0]">    "group_key": </span><span class="text-[#ffab70]">"UJ8MoUlIVpI7pJFzgsYNv37RuHe2TelIaYZ1Yo5bDMNo"</span><span class="text-[#9db1c5]">,</span>
<span class="text-[#b392f0]">    "deleted_at": </span><span class="text-[#9db1c5]">null,</span>
<span class="text-[#b392f0]">    "url": </span><span class="text-[#9db1c5]">null</span>
<span class="text-[#b392f0]">  },</span>
<span class="text-[#b392f0]">  "route": </span><span class="text-[#ffab70]">"2a068e4d9b57a28687ae4dc3b09ff1fb"</span>
<span class="text-[#b392f0]">}</span></pre>
                        </div>
                    </div>
                </div>
