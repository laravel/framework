...
class StubPublishCommand extends Command
{
    ...
    public function handle()
    {
        ...
        $files = [
            ...
            realpath(__DIR__.'/../../Foundation/Console/stubs/cast.stub') => $stubsPath.'/cast.stub',
            realpath(__DIR__.'/../../Foundation/Console/stubs/channel.stub') => $stubsPath.'/channel.stub',
            realpath(__DIR__.'/../../Foundation/Console/stubs/event.stub') => $stubsPath.'/event.stub',
            realpath(__DIR__.'/../../Foundation/Console/stubs/exception.stub') => $stubsPath.'/exception.stub',
            ...
            realpath(__DIR__.'/../../Foundation/Console/stubs/mail.stub') => $stubsPath.'/mail.stub',
            realpath(__DIR__.'/../../Foundation/Console/stubs/markdown-mail.stub') => $stubsPath.'/markdown-mail.stub',
            ...
            realpath(__DIR__.'/../../Foundation/Console/stubs/view-component.stub') => $stubsPath.'/view-component.stub',
            realpath(__DIR__.'/../../Foundation/Console/stubs/observer.plain.stub') => $stubsPath.'/observer.plain.stub',
            realpath(__DIR__.'/../../Foundation/Console/stubs/observer.stub') => $stubsPath.'/observer.stub',
