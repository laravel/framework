...
return array_map('realpath', array(
    ...
    $basePath.'/vendor/laravel/framework/src/Illuminate/Session/Middleware/Reader.php',
    $basePath.'/vendor/laravel/framework/src/Illuminate/Session/Middleware/Writer.php',
