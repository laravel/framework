...
return [
    ...
    $basePath.'/vendor/laravel/framework/src/Illuminate/Foundation/Http/Middleware/ValidatePostSize.php',
    ...
    $basePath.'/vendor/laravel/framework/src/Illuminate/Routing/RouteAction.php',
    $basePath.'/vendor/laravel/framework/src/Illuminate/Routing/ImplicitRouteBinding.php',
    $basePath.'/vendor/laravel/framework/src/Illuminate/Routing/RouteSignatureParameters.php',
    $basePath.'/vendor/laravel/framework/src/Illuminate/Routing/RouteGroup.php',
    ...
    $basePath.'/vendor/laravel/framework/src/Illuminate/Routing/MiddlewareNameResolver.php',
    ...
    $basePath.'/vendor/laravel/framework/src/Illuminate/Foundation/Http/Events/RequestHandled.php',
