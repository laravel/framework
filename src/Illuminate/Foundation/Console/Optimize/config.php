...
return array_map('realpath', array(
    ...
    $basePath.'/vendor/laravel/framework/src/Illuminate/Session/Middlewares/Reader.php',
    $basePath.'/vendor/laravel/framework/src/Illuminate/Session/Middlewares/Writer.php',
    ...
    $basePath.'/vendor/laravel/framework/src/Illuminate/Cookie/Middleware/Guard.php',
    $basePath.'/vendor/laravel/framework/src/Illuminate/Cookie/Middleware/Queue.php',
