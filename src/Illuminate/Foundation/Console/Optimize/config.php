...
return array_map('realpath', array(
    ...
    $basePath.'/vendor/laravel/framework/src/Illuminate/Contracts/Database/ConnectionResolver.php',
    ...
    $basePath.'/vendor/laravel/framework/src/Illuminate/Session/StoreInterface.php',
    ...
    $basePath.'/vendor/laravel/framework/src/Illuminate/Contracts/View/ViewFinder.php',
    ...
    $basePath.'/vendor/laravel/framework/src/Illuminate/Contracts/View/Compiler.php',
