...
class Validator implements ValidatorContract
{
    ...
    protected function validateUrl($attribute, $value, $parameters)
    {
        ...
        if (isset($parameters['protocol']) && $parameters['protocol'] == 'any') {
            $protocol = '[a-z]\w+\-[a-z]\w+|';
