...
class ConditionalRules
{
     ...
     *
     * @var array|string|\Closure|\Illuminate\Contracts\Validation\ValidationRule|\Illuminate\Contracts\Validation\InvokableRule|\Illuminate\Contracts\Validation\Rule
     */
    protected $rules;
     ...
     * @param  array|string|\Closure|\Illuminate\Contracts\Validation\ValidationRule|\Illuminate\Contracts\Validation\InvokableRule|\Illuminate\Contracts\Validation\Rule  $rules
     * @param  array|string|\Closure|\Illuminate\Contracts\Validation\ValidationRule|\Illuminate\Contracts\Validation\InvokableRule|\Illuminate\Contracts\Validation\Rule  $defaultRules
     * @return void
     */
