...
trait ValidatesAttributes
{
     ...
     * @return bool
     */
    public function validateUrl($attribute, $value, $parameters = null)
    {
        if (! is_string($value)) {
            return false;
        }
