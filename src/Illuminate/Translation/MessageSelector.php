...
class MessageSelector
{
    ...
    {
        return  match($locale) {
            'az_AZ','bo','bo_CN','bo_IN','dz','dz_BT','id',
            'id_ID','ja','ja_JP','jv','ka','ka_GE','km','km_KH',
            'kn','kn_IN','ko','ko_KR','ms','ms_MY','th','th_TH','tr',
            'tr_CY','tr_TR','vi','vi_VN','zh','zh_CN','zh_HK','zh_SG','zh_TW' => 0,
            'af','af_ZA','bn','bn_BD','bn_IN','bg','bg_BG','ca','ca_AD','ca_ES','ca_FR',
            'ca_IT','da','da_DK','de','de_AT','de_BE','de_CH','de_DE','de_LI','de_LU','el',
            'el_CY','el_GR','en','en_AG','en_AU','en_BW','en_CA','en_DK','en_GB','en_HK',
            'en_IE','en_IN','en_NG','en_NZ','en_PH','en_SG','en_US','en_ZA','en_ZM','en_ZW',
            'eo','eo_US','es','es_AR','es_BO','es_CL','es_CO','es_CR','es_CU','es_DO','es_EC','es_ES',
            'es_GT','es_HN','es_MX','es_NI','es_PA','es_PE','es_PR','es_PY','es_SV','es_US','es_UY',
            'es_VE','et','et_EE','eu','eu_ES','eu_FR','fa','fa_IR','fi','fi_FI','fo','fo_FO','fur',
            'fur_IT','fy','fy_DE','fy_NL','gl','gl_ES','gu','gu_IN','ha','ha_NG','he','he_IL','hu',
            'hu_HU','is','is_IS','it','it_CH','it_IT','ku','ku_TR','lb','lb_LU','ml','ml_IN','mn',
            'mn_MN','mr','mr_IN','nah','nb','nb_NO','ne','ne_NP','nl','nl_AW','nl_BE','nl_NL','nn',
            'nn_NO','no','om','om_ET','om_KE','or','or_IN','pa','pa_IN','pa_PK','pap','pap_AN','pap_AW',
            'pap_CW','ps','ps_AF','pt','pt_BR','pt_PT','so','so_DJ','so_ET','so_KE','so_SO','sq','sq_AL',
            'sq_MK','sv','sv_FI','sv_SE','sw','sw_KE','sw_TZ','ta','ta_IN','ta_LK','te','te_IN','tk',
            'tk_TM','ur','ur_IN','ur_PK','zu','zu_ZA' => ($number == 1) ? 0 : 1,
            'am','am_ET','bh','fil','fil_PH','fr','fr_BE','fr_CA','fr_CH','fr_FR','fr_LU','gun','hi',
            'hi_IN','hy','hy_AM','ln','ln_CD','mg','mg_MG','nso','nso_ZA','ti','ti_ER','ti_ET','wa','wa_BE','xbr'   => (($number == 0) || ($number == 1)) ? 0 : 1,
