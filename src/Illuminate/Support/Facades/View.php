 ...
 * @method static void slot(string $name, ?string $content = null, array $attributes = [])
 ...
 * @method static mixed getFragment(string $name, ?string $default = null)
 * @method static array getFragments()
 * @method static void flushFragments()
 * @method static void startSection(string $section, ?string $content = null)
 ...
 * @method static mixed getSection(string $name, ?string $default = null)
