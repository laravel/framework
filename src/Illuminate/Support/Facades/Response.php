 ...
 * @method static \Symfony\Component\HttpFoundation\StreamedResponse streamDownload(callable $callback, ?string $name = null, array $headers = [], ?string $disposition = 'attachment')
 * @method static \Symfony\Component\HttpFoundation\BinaryFileResponse download(\SplFileInfo|string $file, ?string $name = null, array $headers = [], ?string $disposition = 'attachment')
