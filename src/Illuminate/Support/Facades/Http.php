 ...
 * @method static string fakeGet($url)
 * @method static string fakePost($url)
 * @method static string fakePatch($url)
 * @method static string fakePut($url)
 * @method static string fakeDelete($url)
