 ...
 * @method static \Illuminate\Http\Client\Response getSync(string $url, array|string|null $query = null)
 * @method static \GuzzleHttp\Promise\PromiseInterface getAsync(string $url, array|string|null $query = null)
 ...
 * @method static \Illuminate\Http\Client\Response headSync(string $url, array|string|null $query = null)
 * @method static \GuzzleHttp\Promise\PromiseInterface headAsync(string $url, array|string|null $query = null)
 * @method static \Illuminate\Http\Client\Response|\GuzzleHttp\Promise\PromiseInterface post(string $url, array $data = [])
 * @method static \Illuminate\Http\Client\Response postSync(string $url, array $data = [])
 * @method static \GuzzleHttp\Promise\PromiseInterface postAsync(string $url, array $data = [])
 * @method static \Illuminate\Http\Client\Response|\GuzzleHttp\Promise\PromiseInterface patch(string $url, array $data = [])
 * @method static \Illuminate\Http\Client\Response patchSync(string $url, array $data = [])
 * @method static \GuzzleHttp\Promise\PromiseInterface patchAsync(string $url, array $data = [])
 * @method static \Illuminate\Http\Client\Response|\GuzzleHttp\Promise\PromiseInterface put(string $url, array $data = [])
 * @method static \Illuminate\Http\Client\Response putSync(string $url, array $data = [])
 * @method static \GuzzleHttp\Promise\PromiseInterface putAsync(string $url, array $data = [])
 * @method static \Illuminate\Http\Client\Response|\GuzzleHttp\Promise\PromiseInterface delete(string $url, array $data = [])
 * @method static \Illuminate\Http\Client\Response deleteSync(string $url, array $data = [])
 * @method static \GuzzleHttp\Promise\PromiseInterface deleteAsync(string $url, array $data = [])
 ...
 * @method static \Illuminate\Http\Client\Response sendSync(string $method, string $url, array $options = [])
 * @method static \GuzzleHttp\Promise\PromiseInterface sendAsync(string $method, string $url, array $options = [])
