 ...
 * @method static \GuzzleHttp\Promise\PromiseInterface response(array|string|resource|\Psr\Http\Message\StreamInterface|null $body = null, int $status = 200, array $headers = [])
 * @method static \GuzzleHttp\Psr7\Response psr7Response(array|string|resource|\Psr\Http\Message\StreamInterface|null $body = null, int $status = 200, array $headers = [])
