 ...
 * @method static \Illuminate\Process\Factory assertRan(\Closure|array|string $callback)
 * @method static \Illuminate\Process\Factory assertRanTimes(\Closure|array|string $callback, int $times = 1)
 * @method static \Illuminate\Process\Factory assertRanInOrder(array $callbacks)
 * @method static \Illuminate\Process\Factory assertNotRan(\Closure|array|string $callback)
 * @method static \Illuminate\Process\Factory assertDidntRun(\Closure|array|string $callback)
