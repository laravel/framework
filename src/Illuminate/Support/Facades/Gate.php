 ...
 * @method static mixed getPolicyFor(object|class-string<*> $class)
 * @method static class-string<*> getPolicyClassFor(object|class-string<*> $class)
 * @method static \Illuminate\Auth\Access\Gate guessPolicyNamesUsing(callable $callback)
 * @method static T resolvePolicy<T>(class-string<T> $class)
