 ...
 * @method static \Illuminate\Auth\Access\Response authorize(string $ability, string $message = null, array|mixed $arguments = [])
 * @method static \Illuminate\Auth\Access\Response inspect(string $ability, string $message = null, array|mixed $arguments = [])
