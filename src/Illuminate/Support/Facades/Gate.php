 ...
 * @method static bool allows(iterable|\UnitEnum|string $ability, array $arguments = [])
 * @method static bool denies(iterable|\UnitEnum|string $ability, array $arguments = [])
 ...
 * @method static \Illuminate\Auth\Access\Response authorize(\UnitEnum|string $ability, array $arguments = [])
 * @method static \Illuminate\Auth\Access\Response inspect(\UnitEnum|string $ability, array $arguments = [])
 * @method static mixed raw(string $ability, array $arguments = [])
