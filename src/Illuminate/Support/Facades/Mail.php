...
/**
 * @method static \Illuminate\Contracts\Mail\Mailer mailer(?string $name = null)
 * @method static \Illuminate\Mail\Mailer driver(?string $driver = null)
 ...
 * @method static void alwaysFrom(string $address, ?string $name = null)
 * @method static void alwaysReplyTo(string $address, ?string $name = null)
 * @method static void alwaysReturnPath(string $address)
 * @method static void alwaysTo(string $address, ?string $name = null)
 ...
 * @method static mixed later(\DateTimeInterface|\DateInterval|int $delay, \Illuminate\Contracts\Mail\Mailable $view, ?string $queue = null)
