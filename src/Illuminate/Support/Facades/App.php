 ...
 * @method static void bootstrapWith(array<int, string> $bootstrappers)
 ...
 * @method static void fireAfterResolvingAttributeCallbacks(array<int, \ReflectionAttribute> $attributes, mixed $object)
