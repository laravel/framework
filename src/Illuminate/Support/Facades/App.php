 ...
 * @method static void setLocale(\UnitEnum|string $locale)
 * @method static void setFallbackLocale(\UnitEnum|string $fallbackLocale)
 * @method static bool isLocale(\UnitEnum|string $locale)
