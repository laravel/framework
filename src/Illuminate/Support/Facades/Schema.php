 ...
 * @method static array getTables(string|array<int, string>|null $schema = null)
 * @method static array getTableListing(string|array<int, string>|null $schema = null, bool $schemaQualified = true)
 * @method static array getViews(string|array<int, string>|null $schema = null)
 * @method static array getTypes(string|array<int, string>|null $schema = null)
 ...
 * @method static array<int, string>|null getCurrentSchemaListing()
