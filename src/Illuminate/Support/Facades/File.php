 ...
 * @method static array<int, \Symfony\Component\Finder\SplFileInfo> files(string $directory, bool $hidden = false, array|string|int $depth = 0)
 * @method static array<int, \Symfony\Component\Finder\SplFileInfo> allFiles(string $directory, bool $hidden = false)
