 ...
 * @method static array|string basename(string $path)
 * @method static array|string dirname(string $path)
 ...
 * @method static false|array glob(string $pattern, int $flags = 0)
