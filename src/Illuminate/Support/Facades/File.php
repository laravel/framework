 ...
 * @method static string decryptedContents(string $path)
 * @method static void decryptedStream(string $path, callable $callback)
 * @method static bool isEncrypted(string $path)
