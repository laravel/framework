 ...
 * @method static \Illuminate\Cache\RefreshOperation|mixed refresh(string $key, \Closure|null $callback = null, \Closure|\DateTimeInterface|\DateInterval|int|null $ttl = null)
