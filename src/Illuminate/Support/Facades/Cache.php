 ...
 * @method static mixed rememberIf(bool $condition, string $key, \Closure|\DateTimeInterface|\DateInterval|int|null $ttl, \Closure $callback)
 * @method static mixed sear(string $key, \Closure $callback)
 * @method static mixed rememberForever(string $key, \Closure $callback)
 * @method static mixed rememberForeverIf(bool $condition, string $key, \Closure $callback)
