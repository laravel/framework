 ...
 * @method static mixed rememberUnless(bool|\Closure(): bool $condition, \UnitEnum|string $key, \Closure|\DateTimeInterface|\DateInterval|int|null $ttl, \Closure $callback)
 ...
 * @method static mixed rememberForeverUnless(bool|\Closure(): bool $condition, \UnitEnum|string $key, \Closure $callback)
