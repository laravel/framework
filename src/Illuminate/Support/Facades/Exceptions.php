 ...
 * @method static \Illuminate\Foundation\Exceptions\Handler dontRetry(array|string $exceptions)
 * @method static \Illuminate\Foundation\Exceptions\Handler dontRetryWhen(callable $dontRetryWhen)
 ...
 * @method static void assertReportedTimes(\Closure|string $exception, int $times = 1)
 * @method static void assertReportedOnce(\Closure|string $exception)
