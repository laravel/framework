 ...
 * @method static \Illuminate\Foundation\Exceptions\Handler level(string<\Throwable> $type, string $level)
 ...
 * @method static void assertReported(\Closure|string<\Throwable> $exception)
 * @method static void assertReportedCount(int $count)
 * @method static void assertNotReported(\Closure|string<\Throwable> $exception)
 ...
 * @method static array<\Throwable> reported()
