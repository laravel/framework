 ...
 * @method static \Illuminate\Database\Query\Builder table(\Closure|\Illuminate\Database\Query\Builder|string $table, ?string $as = null)
 ...
 * @method static ?string getNameWithReadWriteType()
 ...
 * @method static \Illuminate\Database\Connection setReadWriteType(?string $readWriteType)
