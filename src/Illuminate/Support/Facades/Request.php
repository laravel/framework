 ...
 * @method static void setFormat(string|null $format, string|array $mimeTypes)
 ...
 * @method static \Illuminate\Http\UploadedFile|array|null file(string|null $key = null, mixed $default = null)
