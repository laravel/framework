 ...
 * @method static ?string segment(int $index, ?string $default = null)
 ...
 * @method static \Symfony\Component\HttpFoundation\ParameterBag|mixed json(?string $key = null, mixed $default = null)
 ...
 * @method static \Illuminate\Routing\Route|object|string|null route(?string $param = null, mixed $default = null)
 ...
 * @method static ?string getContentTypeFormat()
 ...
 * @method static ?string getPreferredFormat(?string $default = 'html')
 * @method static ?string getPreferredLanguage(string[] $locales = null)
 ...
 * @method static ?string prefers(string|array $contentTypes)
 ...
 * @method static string|array|null old(?string $key = null, \Illuminate\Database\Eloquent\Model|string|array|null $default = null)
 * @method static void flash()
 * @method static void flashOnly(array|mixed $keys)
 * @method static void flashExcept(array|mixed $keys)
 * @method static void flush()
 * @method static string|array|null server(?string $key = null, string|array|null $default = null)
 * @method static bool hasHeader(string $key)
 * @method static string|array|null header(?string $key = null, string|array|null $default = null)
 ...
 * @method static \Illuminate\Support\Carbon|null date(string $key, ?string $format = null, ?string $tz = null)
 ...
 * @method static string|array|null query(?string $key = null, string|array|null $default = null)
 * @method static string|array|null post(?string $key = null, string|array|null $default = null)
 * @method static bool hasCookie(string $key)
 * @method static string|array|null cookie(?string $key = null, string|array|null $default = null)
 * @method static array allFiles()
 * @method static bool hasFile(string $key)
 * @method static \Illuminate\Http\UploadedFile|\Illuminate\Http\UploadedFile[]|array|null file(?string $key = null, mixed $default = null)
