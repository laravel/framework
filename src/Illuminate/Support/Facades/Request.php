 ...
 * @method static array<int, string> getTrustedProxies()
 * @method static int getTrustedHeaderSet()
 * @method static void setTrustedHosts(array $hostPatterns)
 * @method static array<int, string> getTrustedHosts()
 ...
 * @method static void setAllowedHttpMethodOverride(array<int, string>|null $methods)
 * @method static array<int, string>|null getAllowedHttpMethodOverride()
 ...
 * @method static array<int, string> getMimeTypes(string $format)
 * @method static string|null getFormat(string|null $mimeType, bool $subtypeFallback = null)
 * @method static void setFormat(string $format, string|array<int, string> $mimeTypes)
 ...
 * @method static string|null getPreferredLanguage(array<int, string> $locales = null)
 * @method static array<int, string> getLanguages()
 * @method static array<int, string> getCharsets()
 * @method static array<int, string> getEncodings()
 ...
 * @method static array|\Illuminate\Http\UploadedFile|array<int, \Illuminate\Http\UploadedFile>|null file(string|null $key = null, mixed $default = null)
 ...
 * @method static array<int, \BackedEnum> enums(string $key, string $enumClass)
