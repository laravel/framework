 ...
 * @method static \Illuminate\Http\Request createFrom(\self $from, \Illuminate\Http\Request|null $to = null)
 ...
 * @method static void setFormat(string|null $format, array|string $mimeTypes)
 ...
 * @method static string|null getPreferredLanguage(array|null $locales = null)
