 ...
 * @method static void pause(\UnitEnum|string $queue, \UnitEnum|string|null $connection = null)
 * @method static void pauseFor(\UnitEnum|string $queue, \DateTimeInterface|\DateInterval|int $ttl, \UnitEnum|string|null $connection = null)
 * @method static void pauseAll()
 * @method static void resume(\UnitEnum|string $queue, \UnitEnum|string|null $connection = null)
