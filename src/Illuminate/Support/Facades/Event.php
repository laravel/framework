 ...
 * @method static array|null dispatch(string|object $event, mixed $payload = [], bool $halt = false, bool $sync = false)
 * @method static array|null dispatchSync(string|object $event, mixed $payload = [], bool $halt = false)
