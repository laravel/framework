 ...
 * @method static \Illuminate\Routing\Router|null current()
 ...
 * @method static \Illuminate\Routing\Router|null getCurrentRoute()
 ...
 * @method static \Illuminate\Routing\Router view(string $uri, string $view, array $data = [], int|array $status = 200, array $headers = [])
