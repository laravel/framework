 ...
 * @method static \Illuminate\Routing\Route redirect(string $uri, string $destination, int $status = 302, bool $preserveQueryParameters = false)
 * @method static \Illuminate\Routing\Route permanentRedirect(string $uri, string $destination, bool $preserveQueryParameters = false)
