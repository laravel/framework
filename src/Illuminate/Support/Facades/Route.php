 ...
 * @method static array mergeWithLastGroup(array $new, bool $prependExistingPrefix = true, bool $prependExisitingSuffix = true)
 * @method static string getLastGroupPrefix()
 * @method static string getLastGroupSuffix()
 ...
 * @method static \Illuminate\Routing\RouteRegistrar suffix(string $suffix)
