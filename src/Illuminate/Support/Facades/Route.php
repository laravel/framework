...
/**
 * @method static \Illuminate\Routing\Route get(string $uri, \Closure | array | string | null $action) Register a new GET route with the router.
 * @method static \Illuminate\Routing\Route post(string $uri, \Closure | array | string | null $action) Register a new POST route with the router.
 * @method static \Illuminate\Routing\Route put(string $uri, \Closure | array | string | null $action) Register a new PUT route with the router.
 * @method static \Illuminate\Routing\Route patch(string $uri, \Closure | array | string | null $action) Register a new PATCH route with the router.
 * @method static \Illuminate\Routing\Route delete(string $uri, \Closure | array | string | null $action) Register a new DELETE route with the router.
 * @method static \Illuminate\Routing\Route options(string $uri, \Closure | array | string | null $action) Register a new OPTIONS route with the router.
 * @method static \Illuminate\Routing\Route any(string $uri, \Closure | array | string | null $action) Register a new route responding to all verbs.
 * @method static \Illuminate\Routing\Route fallback(\Closure | array | string | null $action) Register a new Fallback route with the router.
 * @method static \Illuminate\Routing\Route redirect(string $uri, string $destination, int $status) Create a redirect from one URI to another.
 * @method static \Illuminate\Routing\Route view(string $uri, string $view, array $data) Register a new route that returns a view.
 * @method static \Illuminate\Routing\Route match(array | string $methods, string $uri, \Closure | array | string | null $action) Register a new route with the given verbs.
 ...
 * @method static \Illuminate\Http\Response|\Illuminate\Http\JsonResponse toResponse(\Symfony\Component\HttpFoundation\Request $request, mixed $response) static version substituteBindings(\Illuminate\Routing\Route $route) Substitute the route bindings onto the route.
