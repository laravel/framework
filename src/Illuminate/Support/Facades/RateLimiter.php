 ...
 * @method static array{allowed: bool, remaining: float, retryAfter: int} tokenBucket(string $key, int|float $capacity, int|float $refillPerSecond = 1, int|float $cost = 1, bool $consume = true)
 * @method static int remainingTokens(string $key, int|float $capacity, int|float $refillPerSecond = 1)
 * @method static int availableInTokenBucket(string $key, int|float $capacity, int|float $refillPerSecond = 1, int|float $cost = 1)
