...
class Collection implements ArrayAccess, Arrayable, Countable, IteratorAggregate, Jsonable, JsonSerializable
{
    ...
    /**
     *
     * Run closure on each slice.
     *
     * @param int $sliceSize
     * @param \Closure $closure
     * @return $this
     */
    public function sliceLoop($sliceSize = 100, \Closure $closure)
    {
        $step = 0;

        do {
            $slice = $this->slice($sliceSize * $step++, $sliceSize);

            if ($slice->isEmpty()) {
                return $this;
            }

            if ($closure($slice, $this, $step) === false) {
                return $this;
            }
