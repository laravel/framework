...
trait CanBeOneOfMany
{
    ...
    {
        return $this->ofMany(collect(Arr::wrap($column))->mapWithKeys(fn ($column) => [$column => 'MAX'])->all(), 'MAX', $relation);
    }
    ...
    {
        return $this->ofMany(collect(Arr::wrap($column))->mapWithKeys(fn ($column) => [$column => 'MIN'])->all(), 'MIN', $relation);
    }
