...
trait QueriesRelationships
{
     ...
     * @return $this
     */
    public function whereBelongsToById(mixed $related, string $relationshipName, string $boolean = 'and', bool $not = false): static
    {
     ...
     * @return $this
     */
    public function orWhereBelongsToById(mixed $related, string $relationshipName): static
    {
     ...
     * @return $this
     */
    public function whereNotBelongsToById(mixed $related, string $relationshipName, string $boolean = 'and'): static
    {
     ...
     * @return $this
     */
    public function orWhereNotBelongsToById(mixed $related, string $relationshipName): static
    {
