 ...
 * @method static $this addNestedWhereQuery(\Illuminate\Database\Query\Builder $query, string $boolean) Add another query builder as a nested where to the query builder.
