...
abstract class Model implements ArrayAccess, ArrayableInterface, JsonableInterface {
	...
	public function isFillable($key)
	{
		...
		// If the key is in the "fillable" array, we can of course assume that it is
		// a fillable attribute. Otherwise, we will check the guarded array when
		// we need to determine if the attribute is blacklisted on the model.
	...
	public function relationsToArray()
	{
		...
		foreach ($this->getArrayableRelations() as $key => $value)
		{
			...
			// array to the developer, making this consistent with attributes.
