 ...
 * @method ColumnDefinition comment(string $comment) Add a comment to a column (MySQL)
 ...
 * @method ColumnDefinition nullable($value = true) Allows (by default) NULL values to be inserted into the column
 * @method ColumnDefinition storedAs($expression) Create a stored generated column (MySQL)
 * @method ColumnDefinition unsigned() Set INTEGER columns as UNSIGNED (MySQL)
 * @method ColumnDefinition useCurrent() Set TIMESTAMP columns to use CURRENT_TIMESTAMP as default value
