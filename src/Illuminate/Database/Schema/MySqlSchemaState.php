...
class MySqlSchemaState extends SchemaState
{
    ...
    protected function connectionString()
    {
        ...
        if (isset($config['options'][defined('Pdo\Mysql::ATTR_SSL_CA') ? \Pdo\Mysql::ATTR_SSL_CA : \PDO::MYSQL_ATTR_SSL_CA])) {
    ...
    protected function baseVariables(array $config)
    {
        ...
        return [
            ...
            'LARAVEL_LOAD_SSL_CA' => $config['options'][defined('Pdo\Mysql::ATTR_SSL_CA') ? \Pdo\Mysql::ATTR_SSL_CA : \PDO::MYSQL_ATTR_SSL_CA] ?? '', // @phpstan-ignore class.notFound
        ];
    }
