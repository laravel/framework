...
class BladeCompiler extends Compiler implements CompilerInterface
{
    ...
    public function compile($path = null)
    {
        ...
        if (!is_null($this->cachePath)) {
            ...
            if ($this->app['config']['view.remove_whitespace'] === true) {
                $contents = $this->removeWhitespaceFromHTMLContent($contents);
            }
     ...
     * @return mixed
     */
    protected function removeWhitespaceFromHTMLContent($contents)
    {
