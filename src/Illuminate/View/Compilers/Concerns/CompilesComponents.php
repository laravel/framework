...
trait CompilesComponents
{
    ...
    public static function compileClassComponentOpening(string $component, string $alias, string $data, string $hash)
    {
        return implode("\n", [
            ...
            '<?php $component = '.$component.'::resolve('.($data ?: '[]').' + (isset($attributes'.$hash.') && $attributes'.$hash.' instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes'.$hash.'->getIterator() : [])); ?>',
