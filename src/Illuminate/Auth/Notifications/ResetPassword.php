...
class ResetPassword extends Notification
{
	 ...
	 *
	 * @var string|(\Closure(mixed, string): string)|null
	 */
	public static string $createUrlCallback;

	/**
	 * The callback that should be used to build the mail message.
	 *
	 * @var string|(\Closure(mixed, string): \Illuminate\Notifications\Messages\MailMessage)|null
	 */
	public static string $toMailCallback;
