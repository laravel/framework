...
class Container implements ArrayAccess, ContainerContract {
	...
	public function make($abstract, $parameters = array())
	{
		...
		// If we defined any extenders for this type, these will now be
		// applied. This allows for extension of services with other
		// drivers, changing config or wrapping with decorators.
