...
class ResponseFactory implements FactoryContract {
	 ...
	 * @return \Symfony\Component\HttpFoundation\Response
	 */
	public function view($view, $data = [], $status = 200, array $headers = array())
	{
	 ...
	 * @return \Symfony\Component\HttpFoundation\Response
	 */
	public function jsonp($callback, $data = [], $status = 200, array $headers = array(), $options = 0)
	{
	 ...
	 * @return \Symfony\Component\HttpFoundation\Response
	 */
	public function redirectToRoute($route, $parameters = [], $status = 302, $headers = array())
	{
	 ...
	 * @return \Symfony\Component\HttpFoundation\Response
	 */
	public function redirectToAction($action, $parameters = [], $status = 302, $headers = array())
	{
