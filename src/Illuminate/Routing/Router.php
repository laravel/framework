...
class Router implements RegistrarContract, BindingRegistrar
{
    ...
    /**
     * Register the typical authentication routes for an application, without registration routes.
     *
     * @return void
     */
    public function authWithoutRegistration()
    {
