...
class Router implements RegistrarContract
{
    ...
    public function auth()
    {
        ...
        $this->post('logout', 'Auth\LoginController@logout')->name('logout:post');
        ...
        $this->post('password/email', 'Auth\ForgotPasswordController@sendResetLinkEmail')->name('password.email:post');
