...
- Added `min()` and `max()` and `groupBy()` to Collection as higher order proxies ([#23560](https://github.com/laravel/framework/pull/23560), [#23608](https://github.com/laravel/framework/pull/23608))
